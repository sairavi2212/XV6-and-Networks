...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      4a:	f20080e7          	jalr	-224(ra) # 5f66 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      8c:	ede080e7          	jalr	-290(ra) # 5f66 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f2:	e78080e7          	jalr	-392(ra) # 5f66 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10e:	e5c080e7          	jalr	-420(ra) # 5f66 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1d6:	d94080e7          	jalr	-620(ra) # 5f66 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     31e:	c4c080e7          	jalr	-948(ra) # 5f66 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	f0250513          	addi	a0,a0,-254 # 6238 <malloc+0x214>
     33e:	00006097          	auipc	ra,0x6
     342:	c28080e7          	jalr	-984(ra) # 5f66 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	ef050513          	addi	a0,a0,-272 # 6250 <malloc+0x22c>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	edc98993          	addi	s3,s3,-292 # 6250 <malloc+0x22c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	e9050513          	addi	a0,a0,-368 # 6250 <malloc+0x22c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	e0058593          	addi	a1,a1,-512 # 61d8 <malloc+0x1b4>
    ...
    printf("write failed\n");
     ...
     3f2:	e8250513          	addi	a0,a0,-382 # 6270 <malloc+0x24c>
     3f6:	00006097          	auipc	ra,0x6
     3fa:	b70080e7          	jalr	-1168(ra) # 5f66 <printf>
    exit(1);
     3fe:	4505                	li	a0,1
     ...
     40c:	e5050513          	addi	a0,a0,-432 # 6258 <malloc+0x234>
     410:	00006097          	auipc	ra,0x6
     414:	b56080e7          	jalr	-1194(ra) # 5f66 <printf>
      exit(1);
     418:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     426:	e3650513          	addi	a0,a0,-458 # 6258 <malloc+0x234>
     42a:	00006097          	auipc	ra,0x6
     42e:	b3c080e7          	jalr	-1220(ra) # 5f66 <printf>
    exit(1);
     432:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     44a:	e0a50513          	addi	a0,a0,-502 # 6250 <malloc+0x22c>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	d2ea0a13          	addi	s4,s4,-722 # 6280 <malloc+0x25c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	c8a50513          	addi	a0,a0,-886 # 6288 <malloc+0x264>
     606:	00006097          	auipc	ra,0x6
     60a:	960080e7          	jalr	-1696(ra) # 5f66 <printf>
      exit(1);
     60e:	4505                	li	a0,1
     ...
     620:	c8450513          	addi	a0,a0,-892 # 62a0 <malloc+0x27c>
     624:	00006097          	auipc	ra,0x6
     628:	942080e7          	jalr	-1726(ra) # 5f66 <printf>
      exit(1);
     62c:	4505                	li	a0,1
     ...
     63e:	c9650513          	addi	a0,a0,-874 # 62d0 <malloc+0x2ac>
     642:	00006097          	auipc	ra,0x6
     646:	924080e7          	jalr	-1756(ra) # 5f66 <printf>
      exit(1);
     64a:	4505                	li	a0,1
     ...
     658:	cac50513          	addi	a0,a0,-852 # 6300 <malloc+0x2dc>
     65c:	00006097          	auipc	ra,0x6
     660:	90a080e7          	jalr	-1782(ra) # 5f66 <printf>
      exit(1);
     664:	4505                	li	a0,1
     ...
     676:	c9e50513          	addi	a0,a0,-866 # 6310 <malloc+0x2ec>
     67a:	00006097          	auipc	ra,0x6
     67e:	8ec080e7          	jalr	-1812(ra) # 5f66 <printf>
      exit(1);
     682:	4505                	li	a0,1
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	c90a0a13          	addi	s4,s4,-880 # 6340 <malloc+0x31c>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	b20a8a93          	addi	s5,s5,-1248 # 61d8 <malloc+0x1b4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	bea50513          	addi	a0,a0,-1046 # 6348 <malloc+0x324>
     766:	00006097          	auipc	ra,0x6
     76a:	800080e7          	jalr	-2048(ra) # 5f66 <printf>
      exit(1);
     76e:	4505                	li	a0,1
     ...
     780:	be450513          	addi	a0,a0,-1052 # 6360 <malloc+0x33c>
     784:	00005097          	auipc	ra,0x5
     788:	7e2080e7          	jalr	2018(ra) # 5f66 <printf>
      exit(1);
     78c:	4505                	li	a0,1
     ...
     79a:	b6a50513          	addi	a0,a0,-1174 # 6300 <malloc+0x2dc>
     79e:	00005097          	auipc	ra,0x5
     7a2:	7c8080e7          	jalr	1992(ra) # 5f66 <printf>
      exit(1);
     7a6:	4505                	li	a0,1
     ...
     7b4:	be050513          	addi	a0,a0,-1056 # 6390 <malloc+0x36c>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	7ae080e7          	jalr	1966(ra) # 5f66 <printf>
      exit(1);
     7c0:	4505                	li	a0,1
     ...
     7d2:	bda50513          	addi	a0,a0,-1062 # 63a8 <malloc+0x384>
     7d6:	00005097          	auipc	ra,0x5
     7da:	790080e7          	jalr	1936(ra) # 5f66 <printf>
      exit(1);
     7de:	4505                	li	a0,1
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	9ac58593          	addi	a1,a1,-1620 # 61d0 <malloc+0x1ac>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	98050513          	addi	a0,a0,-1664 # 61c0 <malloc+0x19c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	95450513          	addi	a0,a0,-1708 # 61c0 <malloc+0x19c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	94050513          	addi	a0,a0,-1728 # 61c0 <malloc+0x19c>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	b7a58593          	addi	a1,a1,-1158 # 6438 <malloc+0x414>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	8c050513          	addi	a0,a0,-1856 # 61c0 <malloc+0x19c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	a9450513          	addi	a0,a0,-1388 # 63d8 <malloc+0x3b4>
     94c:	00005097          	auipc	ra,0x5
     950:	61a080e7          	jalr	1562(ra) # 5f66 <printf>
    exit(1);
     954:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	a9850513          	addi	a0,a0,-1384 # 63f8 <malloc+0x3d4>
     968:	00005097          	auipc	ra,0x5
     96c:	5fe080e7          	jalr	1534(ra) # 5f66 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     970:	8652                	mv	a2,s4
     972:	85d6                	mv	a1,s5
     974:	00006517          	auipc	a0,0x6
     978:	a9450513          	addi	a0,a0,-1388 # 6408 <malloc+0x3e4>
     97c:	00005097          	auipc	ra,0x5
     980:	5ea080e7          	jalr	1514(ra) # 5f66 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	a9850513          	addi	a0,a0,-1384 # 6428 <malloc+0x404>
     998:	00005097          	auipc	ra,0x5
     99c:	5ce080e7          	jalr	1486(ra) # 5f66 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9a0:	8652                	mv	a2,s4
     9a2:	85d6                	mv	a1,s5
     9a4:	00006517          	auipc	a0,0x6
     9a8:	a6450513          	addi	a0,a0,-1436 # 6408 <malloc+0x3e4>
     9ac:	00005097          	auipc	ra,0x5
     9b0:	5ba080e7          	jalr	1466(ra) # 5f66 <printf>
    exit(1);
     9b4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	a7e50513          	addi	a0,a0,-1410 # 6440 <malloc+0x41c>
     9ca:	00005097          	auipc	ra,0x5
     9ce:	59c080e7          	jalr	1436(ra) # 5f66 <printf>
    exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	a8050513          	addi	a0,a0,-1408 # 6460 <malloc+0x43c>
     9e8:	00005097          	auipc	ra,0x5
     9ec:	57e080e7          	jalr	1406(ra) # 5f66 <printf>
    exit(1);
     9f0:	4505                	li	a0,1
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	a6c50513          	addi	a0,a0,-1428 # 6480 <malloc+0x45c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	a7c98993          	addi	s3,s3,-1412 # 64a8 <malloc+0x484>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	aaca8a93          	addi	s5,s5,-1364 # 64e0 <malloc+0x4bc>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	a0650513          	addi	a0,a0,-1530 # 6480 <malloc+0x45c>
  ...
  if(unlink("small") < 0){
     ...
     aba:	9ca50513          	addi	a0,a0,-1590 # 6480 <malloc+0x45c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	9a850513          	addi	a0,a0,-1624 # 6488 <malloc+0x464>
     ae8:	00005097          	auipc	ra,0x5
     aec:	47e080e7          	jalr	1150(ra) # 5f66 <printf>
    exit(1);
     af0:	4505                	li	a0,1
     ...
     b02:	9ba50513          	addi	a0,a0,-1606 # 64b8 <malloc+0x494>
     b06:	00005097          	auipc	ra,0x5
     b0a:	460080e7          	jalr	1120(ra) # 5f66 <printf>
      exit(1);
     b0e:	4505                	li	a0,1
     ...
     b20:	9d450513          	addi	a0,a0,-1580 # 64f0 <malloc+0x4cc>
     b24:	00005097          	auipc	ra,0x5
     b28:	442080e7          	jalr	1090(ra) # 5f66 <printf>
      exit(1);
     b2c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	9e050513          	addi	a0,a0,-1568 # 6518 <malloc+0x4f4>
     b40:	00005097          	auipc	ra,0x5
     b44:	426080e7          	jalr	1062(ra) # 5f66 <printf>
    exit(1);
     b48:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	9e450513          	addi	a0,a0,-1564 # 6538 <malloc+0x514>
     b5c:	00005097          	auipc	ra,0x5
     b60:	40a080e7          	jalr	1034(ra) # 5f66 <printf>
    exit(1);
     b64:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	9e050513          	addi	a0,a0,-1568 # 6550 <malloc+0x52c>
     b78:	00005097          	auipc	ra,0x5
     b7c:	3ee080e7          	jalr	1006(ra) # 5f66 <printf>
    exit(1);
     b80:	4505                	li	a0,1
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	9ce50513          	addi	a0,a0,-1586 # 6570 <malloc+0x54c>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	97c50513          	addi	a0,a0,-1668 # 6570 <malloc+0x54c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	93c50513          	addi	a0,a0,-1732 # 6578 <malloc+0x554>
     c44:	00005097          	auipc	ra,0x5
     c48:	322080e7          	jalr	802(ra) # 5f66 <printf>
    exit(1);
     c4c:	4505                	li	a0,1
     ...
     c5e:	93e50513          	addi	a0,a0,-1730 # 6598 <malloc+0x574>
     c62:	00005097          	auipc	ra,0x5
     c66:	304080e7          	jalr	772(ra) # 5f66 <printf>
      exit(1);
     c6a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	94a50513          	addi	a0,a0,-1718 # 65c0 <malloc+0x59c>
     c7e:	00005097          	auipc	ra,0x5
     c82:	2e8080e7          	jalr	744(ra) # 5f66 <printf>
    exit(1);
     c86:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca6:	8ce50513          	addi	a0,a0,-1842 # 6570 <malloc+0x54c>
     ...
     cd2:	91250513          	addi	a0,a0,-1774 # 65e0 <malloc+0x5bc>
     cd6:	00005097          	auipc	ra,0x5
     cda:	290080e7          	jalr	656(ra) # 5f66 <printf>
        exit(1);
     cde:	4505                	li	a0,1
     ...
     cf0:	91c50513          	addi	a0,a0,-1764 # 6608 <malloc+0x5e4>
     cf4:	00005097          	auipc	ra,0x5
     cf8:	272080e7          	jalr	626(ra) # 5f66 <printf>
      exit(1);
     cfc:	4505                	li	a0,1
     ...
     d0e:	91650513          	addi	a0,a0,-1770 # 6620 <malloc+0x5fc>
     d12:	00005097          	auipc	ra,0x5
     d16:	254080e7          	jalr	596(ra) # 5f66 <printf>
      exit(1);
     d1a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	92250513          	addi	a0,a0,-1758 # 6648 <malloc+0x624>
     d2e:	00005097          	auipc	ra,0x5
     d32:	238080e7          	jalr	568(ra) # 5f66 <printf>
    exit(1);
     d36:	4505                	li	a0,1
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	90c50513          	addi	a0,a0,-1780 # 6660 <malloc+0x63c>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	92458593          	addi	a1,a1,-1756 # 6690 <malloc+0x66c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	8d850513          	addi	a0,a0,-1832 # 6660 <malloc+0x63c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	8c250513          	addi	a0,a0,-1854 # 6660 <malloc+0x63c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	8ac50513          	addi	a0,a0,-1876 # 6660 <malloc+0x63c>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	91058593          	addi	a1,a1,-1776 # 66d8 <malloc+0x6b4>
  ...
  unlink("unlinkread");
     ...
     e34:	83050513          	addi	a0,a0,-2000 # 6660 <malloc+0x63c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	82050513          	addi	a0,a0,-2016 # 6670 <malloc+0x64c>
     e58:	00005097          	auipc	ra,0x5
     e5c:	10e080e7          	jalr	270(ra) # 5f66 <printf>
    exit(1);
     e60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	82c50513          	addi	a0,a0,-2004 # 6698 <malloc+0x674>
     e74:	00005097          	auipc	ra,0x5
     e78:	0f2080e7          	jalr	242(ra) # 5f66 <printf>
    exit(1);
     e7c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	83050513          	addi	a0,a0,-2000 # 66b8 <malloc+0x694>
     e90:	00005097          	auipc	ra,0x5
     e94:	0d6080e7          	jalr	214(ra) # 5f66 <printf>
    exit(1);
     e98:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	83c50513          	addi	a0,a0,-1988 # 66e0 <malloc+0x6bc>
     eac:	00005097          	auipc	ra,0x5
     eb0:	0ba080e7          	jalr	186(ra) # 5f66 <printf>
    exit(1);
     eb4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	84050513          	addi	a0,a0,-1984 # 6700 <malloc+0x6dc>
     ec8:	00005097          	auipc	ra,0x5
     ecc:	09e080e7          	jalr	158(ra) # 5f66 <printf>
    exit(1);
     ed0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	84450513          	addi	a0,a0,-1980 # 6720 <malloc+0x6fc>
     ee4:	00005097          	auipc	ra,0x5
     ee8:	082080e7          	jalr	130(ra) # 5f66 <printf>
    exit(1);
     eec:	4505                	li	a0,1
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	75058593          	addi	a1,a1,1872 # 6690 <malloc+0x66c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	7e858593          	addi	a1,a1,2024 # 6748 <malloc+0x724>
     f68:	00005517          	auipc	a0,0x5
     f6c:	7d850513          	addi	a0,a0,2008 # 6740 <malloc+0x71c>
  ...
  unlink("lf1");
     ...
     f80:	7c450513          	addi	a0,a0,1988 # 6740 <malloc+0x71c>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	7b250513          	addi	a0,a0,1970 # 6740 <malloc+0x71c>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	7a450513          	addi	a0,a0,1956 # 6748 <malloc+0x724>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	76c58593          	addi	a1,a1,1900 # 6748 <malloc+0x724>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	75650513          	addi	a0,a0,1878 # 6748 <malloc+0x724>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	73e58593          	addi	a1,a1,1854 # 6740 <malloc+0x71c>
    100a:	00005517          	auipc	a0,0x5
    100e:	73e50513          	addi	a0,a0,1854 # 6748 <malloc+0x724>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	72258593          	addi	a1,a1,1826 # 6740 <malloc+0x71c>
    1026:	00006517          	auipc	a0,0x6
    102a:	82a50513          	addi	a0,a0,-2006 # 6850 <malloc+0x82c>
    ...
    104c:	70850513          	addi	a0,a0,1800 # 6750 <malloc+0x72c>
    1050:	00005097          	auipc	ra,0x5
    1054:	f16080e7          	jalr	-234(ra) # 5f66 <printf>
    exit(1);
    1058:	4505                	li	a0,1
    ...
    1068:	70450513          	addi	a0,a0,1796 # 6768 <malloc+0x744>
    106c:	00005097          	auipc	ra,0x5
    1070:	efa080e7          	jalr	-262(ra) # 5f66 <printf>
    exit(1);
    1074:	4505                	li	a0,1
    ...
    1084:	70050513          	addi	a0,a0,1792 # 6780 <malloc+0x75c>
    1088:	00005097          	auipc	ra,0x5
    108c:	ede080e7          	jalr	-290(ra) # 5f66 <printf>
    exit(1);
    1090:	4505                	li	a0,1
    ...
    10a0:	70450513          	addi	a0,a0,1796 # 67a0 <malloc+0x77c>
    10a4:	00005097          	auipc	ra,0x5
    10a8:	ec2080e7          	jalr	-318(ra) # 5f66 <printf>
    exit(1);
    10ac:	4505                	li	a0,1
    ...
    10bc:	71850513          	addi	a0,a0,1816 # 67d0 <malloc+0x7ac>
    10c0:	00005097          	auipc	ra,0x5
    10c4:	ea6080e7          	jalr	-346(ra) # 5f66 <printf>
    exit(1);
    10c8:	4505                	li	a0,1
    ...
    10d8:	71450513          	addi	a0,a0,1812 # 67e8 <malloc+0x7c4>
    10dc:	00005097          	auipc	ra,0x5
    10e0:	e8a080e7          	jalr	-374(ra) # 5f66 <printf>
    exit(1);
    10e4:	4505                	li	a0,1
    ...
    10f4:	71050513          	addi	a0,a0,1808 # 6800 <malloc+0x7dc>
    10f8:	00005097          	auipc	ra,0x5
    10fc:	e6e080e7          	jalr	-402(ra) # 5f66 <printf>
    exit(1);
    1100:	4505                	li	a0,1
    ...
    1110:	71c50513          	addi	a0,a0,1820 # 6828 <malloc+0x804>
    1114:	00005097          	auipc	ra,0x5
    1118:	e52080e7          	jalr	-430(ra) # 5f66 <printf>
    exit(1);
    111c:	4505                	li	a0,1
    ...
    112c:	73050513          	addi	a0,a0,1840 # 6858 <malloc+0x834>
    1130:	00005097          	auipc	ra,0x5
    1134:	e36080e7          	jalr	-458(ra) # 5f66 <printf>
    exit(1);
    1138:	4505                	li	a0,1
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	71e98993          	addi	s3,s3,1822 # 6878 <malloc+0x854>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	6f250513          	addi	a0,a0,1778 # 6888 <malloc+0x864>
    119e:	00005097          	auipc	ra,0x5
    11a2:	dc8080e7          	jalr	-568(ra) # 5f66 <printf>
      exit(1);
    11a6:	4505                	li	a0,1
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	6aca0a13          	addi	s4,s4,1708 # 68a8 <malloc+0x884>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	65a50513          	addi	a0,a0,1626 # 68a8 <malloc+0x884>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	5f250513          	addi	a0,a0,1522 # 68b0 <malloc+0x88c>
    12c6:	00005097          	auipc	ra,0x5
    12ca:	ca0080e7          	jalr	-864(ra) # 5f66 <printf>
    exit(1);
    12ce:	4505                	li	a0,1
    ...
    12e2:	5f250513          	addi	a0,a0,1522 # 68d0 <malloc+0x8ac>
    12e6:	00005097          	auipc	ra,0x5
    12ea:	c80080e7          	jalr	-896(ra) # 5f66 <printf>
      exit(1);
    12ee:	4505                	li	a0,1
    ...
    12fe:	5f650513          	addi	a0,a0,1526 # 68f0 <malloc+0x8cc>
    1302:	00005097          	auipc	ra,0x5
    1306:	c64080e7          	jalr	-924(ra) # 5f66 <printf>
      exit(1);
    130a:	4505                	li	a0,1
...
000000000000134c <badarg>:
{
    ...
    136a:	e0298993          	addi	s3,s3,-510 # 6168 <malloc+0x144>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	75878793          	addi	a5,a5,1880 # 7b48 <malloc+0x1b24>
  ...
  if(pid == 0){
    ...
    1450:	11c78793          	addi	a5,a5,284 # 8568 <malloc+0x2544>
    ...
    1474:	cf850513          	addi	a0,a0,-776 # 6168 <malloc+0x144>
    ...
    148c:	51050513          	addi	a0,a0,1296 # 6998 <malloc+0x974>
    1490:	00005097          	auipc	ra,0x5
    1494:	ad6080e7          	jalr	-1322(ra) # 5f66 <printf>
      exit(1);
    1498:	4505                	li	a0,1
    ...
    14ac:	46850513          	addi	a0,a0,1128 # 6910 <malloc+0x8ec>
    14b0:	00005097          	auipc	ra,0x5
    14b4:	ab6080e7          	jalr	-1354(ra) # 5f66 <printf>
    exit(1);
    14b8:	4505                	li	a0,1
    ...
    14cc:	46850513          	addi	a0,a0,1128 # 6930 <malloc+0x90c>
    14d0:	00005097          	auipc	ra,0x5
    14d4:	a96080e7          	jalr	-1386(ra) # 5f66 <printf>
    exit(1);
    14d8:	4505                	li	a0,1
    ...
    14ee:	46650513          	addi	a0,a0,1126 # 6950 <malloc+0x92c>
    14f2:	00005097          	auipc	ra,0x5
    14f6:	a74080e7          	jalr	-1420(ra) # 5f66 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    ...
    150e:	46e50513          	addi	a0,a0,1134 # 6978 <malloc+0x954>
    1512:	00005097          	auipc	ra,0x5
    1516:	a54080e7          	jalr	-1452(ra) # 5f66 <printf>
    exit(1);
    151a:	4505                	li	a0,1
    ...
    1528:	8d450513          	addi	a0,a0,-1836 # 6df8 <malloc+0xdd4>
    152c:	00005097          	auipc	ra,0x5
    1530:	a3a080e7          	jalr	-1478(ra) # 5f66 <printf>
    exit(1);
    1534:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1572:	45250513          	addi	a0,a0,1106 # 69c0 <malloc+0x99c>
    1576:	00005097          	auipc	ra,0x5
    157a:	9f0080e7          	jalr	-1552(ra) # 5f66 <printf>
    exit(1);
    157e:	4505                	li	a0,1
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	c2050513          	addi	a0,a0,-992 # 61c0 <malloc+0x19c>
  ...
  if(pid == 0){
    ...
    15ce:	bf6a0a13          	addi	s4,s4,-1034 # 61c0 <malloc+0x19c>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	44ea8a93          	addi	s5,s5,1102 # 6a20 <malloc+0x9fc>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	3ae50513          	addi	a0,a0,942 # 69f0 <malloc+0x9cc>
    164a:	00005097          	auipc	ra,0x5
    164e:	91c080e7          	jalr	-1764(ra) # 5f66 <printf>
    exit(1);
    1652:	4505                	li	a0,1
    ...
    1662:	3aa50513          	addi	a0,a0,938 # 6a08 <malloc+0x9e4>
    1666:	00005097          	auipc	ra,0x5
    166a:	900080e7          	jalr	-1792(ra) # 5f66 <printf>
        exit(1);
    166e:	4505                	li	a0,1
    ...
    1680:	3b450513          	addi	a0,a0,948 # 6a30 <malloc+0xa0c>
    1684:	00005097          	auipc	ra,0x5
    1688:	8e2080e7          	jalr	-1822(ra) # 5f66 <printf>
        exit(1);
    168c:	4505                	li	a0,1
    ...
    169e:	b26a0a13          	addi	s4,s4,-1242 # 61c0 <malloc+0x19c>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	3aea8a93          	addi	s5,s5,942 # 6a50 <malloc+0xa2c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	ad450513          	addi	a0,a0,-1324 # 61c0 <malloc+0x19c>
  ...
  exit(xstatus);
    ...
    170e:	2fe50513          	addi	a0,a0,766 # 6a08 <malloc+0x9e4>
    1712:	00005097          	auipc	ra,0x5
    1716:	854080e7          	jalr	-1964(ra) # 5f66 <printf>
      exit(1);
    171a:	4505                	li	a0,1
    ...
    172c:	33050513          	addi	a0,a0,816 # 6a58 <malloc+0xa34>
    1730:	00005097          	auipc	ra,0x5
    1734:	836080e7          	jalr	-1994(ra) # 5f66 <printf>
      exit(1);
    1738:	4505                	li	a0,1
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	a1878793          	addi	a5,a5,-1512 # 6168 <malloc+0x144>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	31c78793          	addi	a5,a5,796 # 6a78 <malloc+0xa54>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	31450513          	addi	a0,a0,788 # 6a80 <malloc+0xa5c>
  ...
  if(pid == 0) {
    ...
    179e:	2e650513          	addi	a0,a0,742 # 6a80 <malloc+0xa5c>
    ...
    17ba:	2ea50513          	addi	a0,a0,746 # 6aa0 <malloc+0xa7c>
    17be:	00004097          	auipc	ra,0x4
    17c2:	7a8080e7          	jalr	1960(ra) # 5f66 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	21e50513          	addi	a0,a0,542 # 69f0 <malloc+0x9cc>
    17da:	00004097          	auipc	ra,0x4
    17de:	78c080e7          	jalr	1932(ra) # 5f66 <printf>
     exit(1);
    17e2:	4505                	li	a0,1
    ...
    17f2:	29a50513          	addi	a0,a0,666 # 6a88 <malloc+0xa64>
    17f6:	00004097          	auipc	ra,0x4
    17fa:	770080e7          	jalr	1904(ra) # 5f66 <printf>
      exit(1);
    17fe:	4505                	li	a0,1
    ...
    1810:	95c50513          	addi	a0,a0,-1700 # 6168 <malloc+0x144>
  ...
  if(xstatus != 0)
    ...
    1844:	27050513          	addi	a0,a0,624 # 6ab0 <malloc+0xa8c>
    1848:	00004097          	auipc	ra,0x4
    184c:	71e080e7          	jalr	1822(ra) # 5f66 <printf>
      exit(1);
    1850:	4505                	li	a0,1
    ...
    1860:	26c50513          	addi	a0,a0,620 # 6ac8 <malloc+0xaa4>
    1864:	00004097          	auipc	ra,0x4
    1868:	702080e7          	jalr	1794(ra) # 5f66 <printf>
    186c:	b7d1                	j	1830 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186e:	4581                	li	a1,0
    1870:	00005517          	auipc	a0,0x5
    1874:	21050513          	addi	a0,a0,528 # 6a80 <malloc+0xa5c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	c9e50513          	addi	a0,a0,-866 # 6538 <malloc+0x514>
    18a2:	00004097          	auipc	ra,0x4
    18a6:	6c4080e7          	jalr	1732(ra) # 5f66 <printf>
    exit(1);
    18aa:	4505                	li	a0,1
    ...
    18ba:	15250513          	addi	a0,a0,338 # 6a08 <malloc+0x9e4>
    18be:	00004097          	auipc	ra,0x4
    18c2:	6a8080e7          	jalr	1704(ra) # 5f66 <printf>
    exit(1);
    18c6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d4:	1b050513          	addi	a0,a0,432 # 6a80 <malloc+0xa5c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	1e650513          	addi	a0,a0,486 # 6ae0 <malloc+0xabc>
    1902:	00004097          	auipc	ra,0x4
    1906:	664080e7          	jalr	1636(ra) # 5f66 <printf>
    exit(1);
    190a:	4505                	li	a0,1
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	13c50513          	addi	a0,a0,316 # 6af8 <malloc+0xad4>
    19c4:	00004097          	auipc	ra,0x4
    19c8:	5a2080e7          	jalr	1442(ra) # 5f66 <printf>
    exit(1);
    19cc:	4505                	li	a0,1
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	0ce50513          	addi	a0,a0,206 # 6b10 <malloc+0xaec>
    1a4a:	00004097          	auipc	ra,0x4
    1a4e:	51c080e7          	jalr	1308(ra) # 5f66 <printf>
        exit(1);
    1a52:	4505                	li	a0,1
    ...
    1a62:	0ca50513          	addi	a0,a0,202 # 6b28 <malloc+0xb04>
    1a66:	00004097          	auipc	ra,0x4
    1a6a:	500080e7          	jalr	1280(ra) # 5f66 <printf>
}
    ...
    1a94:	0b050513          	addi	a0,a0,176 # 6b40 <malloc+0xb1c>
    1a98:	00004097          	auipc	ra,0x4
    1a9c:	4ce080e7          	jalr	1230(ra) # 5f66 <printf>
      exit(1);
    1aa0:	4505                	li	a0,1
    ...
    1ad4:	09050513          	addi	a0,a0,144 # 6b60 <malloc+0xb3c>
    1ad8:	00004097          	auipc	ra,0x4
    1adc:	48e080e7          	jalr	1166(ra) # 5f66 <printf>
    exit(1);
    1ae0:	4505                	li	a0,1
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	eae50513          	addi	a0,a0,-338 # 69f0 <malloc+0x9cc>
    1b4a:	00004097          	auipc	ra,0x4
    1b4e:	41c080e7          	jalr	1052(ra) # 5f66 <printf>
      exit(1);
    1b52:	4505                	li	a0,1
    ...
    1b62:	01a50513          	addi	a0,a0,26 # 6b78 <malloc+0xb54>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	400080e7          	jalr	1024(ra) # 5f66 <printf>
        exit(1);
    1b6e:	4505                	li	a0,1
    ...
    1b7e:	01650513          	addi	a0,a0,22 # 6b90 <malloc+0xb6c>
    1b82:	00004097          	auipc	ra,0x4
    1b86:	3e4080e7          	jalr	996(ra) # 5f66 <printf>
        exit(1);
    1b8a:	4505                	li	a0,1
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	dfe50513          	addi	a0,a0,-514 # 69f0 <malloc+0x9cc>
    1bfa:	00004097          	auipc	ra,0x4
    1bfe:	36c080e7          	jalr	876(ra) # 5f66 <printf>
      exit(1);
    1c02:	4505                	li	a0,1
    ...
    1c1a:	dda50513          	addi	a0,a0,-550 # 69f0 <malloc+0x9cc>
    1c1e:	00004097          	auipc	ra,0x4
    1c22:	348080e7          	jalr	840(ra) # 5f66 <printf>
        exit(1);
    1c26:	4505                	li	a0,1
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	f2050513          	addi	a0,a0,-224 # 6bb0 <malloc+0xb8c>
    1c98:	00004097          	auipc	ra,0x4
    1c9c:	2ce080e7          	jalr	718(ra) # 5f66 <printf>
      exit(1);
    1ca0:	4505                	li	a0,1
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	ed850513          	addi	a0,a0,-296 # 6bc0 <malloc+0xb9c>
    1cf0:	00004097          	auipc	ra,0x4
    1cf4:	276080e7          	jalr	630(ra) # 5f66 <printf>
      exit(1);
    1cf8:	4505                	li	a0,1
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	0c250513          	addi	a0,a0,194 # 6df8 <malloc+0xdd4>
    1d3e:	00004097          	auipc	ra,0x4
    1d42:	228080e7          	jalr	552(ra) # 5f66 <printf>
      exit(1);
    1d46:	4505                	li	a0,1
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	02450513          	addi	a0,a0,36 # 6df8 <malloc+0xdd4>
    1ddc:	00004097          	auipc	ra,0x4
    1de0:	18a080e7          	jalr	394(ra) # 5f66 <printf>
      exit(1);
    1de4:	4505                	li	a0,1
    ...
    1e04:	c8850513          	addi	a0,a0,-888 # 6a88 <malloc+0xa64>
    1e08:	00004097          	auipc	ra,0x4
    1e0c:	15e080e7          	jalr	350(ra) # 5f66 <printf>
          exit(1);
    1e10:	4505                	li	a0,1
    ...
    1e76:	d6e50513          	addi	a0,a0,-658 # 6be0 <malloc+0xbbc>
    1e7a:	00004097          	auipc	ra,0x4
    1e7e:	0ec080e7          	jalr	236(ra) # 5f66 <printf>
            exit(1);
    1e82:	4505                	li	a0,1
    ...
    1eaa:	d5250513          	addi	a0,a0,-686 # 6bf8 <malloc+0xbd4>
    1eae:	00004097          	auipc	ra,0x4
    1eb2:	0b8080e7          	jalr	184(ra) # 5f66 <printf>
        exit(1);
    1eb6:	4505                	li	a0,1
    ...
    1f10:	d1450513          	addi	a0,a0,-748 # 6c20 <malloc+0xbfc>
    1f14:	00004097          	auipc	ra,0x4
    1f18:	052080e7          	jalr	82(ra) # 5f66 <printf>
        exit(1);
    1f1c:	4505                	li	a0,1
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	22c50513          	addi	a0,a0,556 # 61d8 <malloc+0x1b4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	1f0a8a93          	addi	s5,s5,496 # 61d8 <malloc+0x1b4>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	c58b8b93          	addi	s7,s7,-936 # 6c48 <malloc+0xc24>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	9f450513          	addi	a0,a0,-1548 # 69f0 <malloc+0x9cc>
    2004:	00004097          	auipc	ra,0x4
    2008:	f62080e7          	jalr	-158(ra) # 5f66 <printf>
    exit(1);
    200c:	4505                	li	a0,1
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	baa50513          	addi	a0,a0,-1110 # 6c68 <malloc+0xc44>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	ea0080e7          	jalr	-352(ra) # 5f66 <printf>
    exit(1);
    20ce:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2124:	b3050513          	addi	a0,a0,-1232 # 6c50 <malloc+0xc2c>
    2128:	00004097          	auipc	ra,0x4
    212c:	e3e080e7          	jalr	-450(ra) # 5f66 <printf>
    exit(1);
    2130:	4505                	li	a0,1
    ...
    2140:	b5450513          	addi	a0,a0,-1196 # 6c90 <malloc+0xc6c>
    2144:	00004097          	auipc	ra,0x4
    2148:	e22080e7          	jalr	-478(ra) # 5f66 <printf>
      exit(1);
    214c:	4505                	li	a0,1
    ...
    215c:	b5050513          	addi	a0,a0,-1200 # 6ca8 <malloc+0xc84>
    2160:	00004097          	auipc	ra,0x4
    2164:	e06080e7          	jalr	-506(ra) # 5f66 <printf>
    exit(1);
    2168:	4505                	li	a0,1
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	81850513          	addi	a0,a0,-2024 # 69f0 <malloc+0x9cc>
    21e0:	00004097          	auipc	ra,0x4
    21e4:	d86080e7          	jalr	-634(ra) # 5f66 <printf>
      exit(1);
    21e8:	4505                	li	a0,1
    ...
    21fe:	ac650513          	addi	a0,a0,-1338 # 6cc0 <malloc+0xc9c>
    2202:	00004097          	auipc	ra,0x4
    2206:	d64080e7          	jalr	-668(ra) # 5f66 <printf>
      exit(1);
    220a:	4505                	li	a0,1
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	77450513          	addi	a0,a0,1908 # 69f0 <malloc+0x9cc>
    2284:	00004097          	auipc	ra,0x4
    2288:	ce2080e7          	jalr	-798(ra) # 5f66 <printf>
      exit(1);
    228c:	4505                	li	a0,1
    ...
    22ac:	a3850513          	addi	a0,a0,-1480 # 6ce0 <malloc+0xcbc>
    22b0:	00004097          	auipc	ra,0x4
    22b4:	cb6080e7          	jalr	-842(ra) # 5f66 <printf>
      exit(1);
    22b8:	4505                	li	a0,1
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	a2050513          	addi	a0,a0,-1504 # 6cf8 <malloc+0xcd4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	9ee50513          	addi	a0,a0,-1554 # 6cf8 <malloc+0xcd4>
  ...
  close(fd);
    ...
    2344:	9c870713          	addi	a4,a4,-1592 # 6d08 <malloc+0xce4>
    ...
    2398:	a5450513          	addi	a0,a0,-1452 # 6de8 <malloc+0xdc4>
    239c:	00004097          	auipc	ra,0x4
    23a0:	bca080e7          	jalr	-1078(ra) # 5f66 <printf>
    exit(1);
    23a4:	4505                	li	a0,1
    ...
    23bc:	a5050513          	addi	a0,a0,-1456 # 6e08 <malloc+0xde4>
    23c0:	00004097          	auipc	ra,0x4
    23c4:	ba6080e7          	jalr	-1114(ra) # 5f66 <printf>
    exit(1);
    23c8:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    241a:	a1250513          	addi	a0,a0,-1518 # 6e28 <malloc+0xe04>
    241e:	00004097          	auipc	ra,0x4
    2422:	b48080e7          	jalr	-1208(ra) # 5f66 <printf>
    exit(1);
    2426:	4505                	li	a0,1
    ...
    2436:	5be50513          	addi	a0,a0,1470 # 69f0 <malloc+0x9cc>
    243a:	00004097          	auipc	ra,0x4
    243e:	b2c080e7          	jalr	-1236(ra) # 5f66 <printf>
    exit(1);
    2442:	4505                	li	a0,1
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	55050513          	addi	a0,a0,1360 # 69f0 <malloc+0x9cc>
    24a8:	00004097          	auipc	ra,0x4
    24ac:	abe080e7          	jalr	-1346(ra) # 5f66 <printf>
    exit(1);
    24b0:	4505                	li	a0,1
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	8dc50513          	addi	a0,a0,-1828 # 6df8 <malloc+0xdd4>
    2524:	00004097          	auipc	ra,0x4
    2528:	a42080e7          	jalr	-1470(ra) # 5f66 <printf>
      exit(1);
    252c:	4505                	li	a0,1
    ...
    25d0:	88450513          	addi	a0,a0,-1916 # 6e50 <malloc+0xe2c>
    25d4:	00004097          	auipc	ra,0x4
    25d8:	992080e7          	jalr	-1646(ra) # 5f66 <printf>
            exit(1);
    25dc:	4505                	li	a0,1
    ...
    25f0:	c4c50513          	addi	a0,a0,-948 # 6238 <malloc+0x214>
    25f4:	00004097          	auipc	ra,0x4
    25f8:	972080e7          	jalr	-1678(ra) # 5f66 <printf>
            exit(1);
    25fc:	4505                	li	a0,1
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	4c478793          	addi	a5,a5,1220 # 7b48 <malloc+0x1b24>
  ...
  if(ret != -1){
    ...
    26ca:	7a250513          	addi	a0,a0,1954 # 6e68 <malloc+0xe44>
    26ce:	00004097          	auipc	ra,0x4
    26d2:	898080e7          	jalr	-1896(ra) # 5f66 <printf>
    exit(1);
    26d6:	4505                	li	a0,1
    ...
    26e8:	22c50513          	addi	a0,a0,556 # 6910 <malloc+0x8ec>
    26ec:	00004097          	auipc	ra,0x4
    26f0:	87a080e7          	jalr	-1926(ra) # 5f66 <printf>
    exit(1);
    26f4:	4505                	li	a0,1
    ...
    2706:	22e50513          	addi	a0,a0,558 # 6930 <malloc+0x90c>
    270a:	00004097          	auipc	ra,0x4
    270e:	85c080e7          	jalr	-1956(ra) # 5f66 <printf>
    exit(1);
    2712:	4505                	li	a0,1
    ...
    2726:	22e50513          	addi	a0,a0,558 # 6950 <malloc+0x92c>
    272a:	00004097          	auipc	ra,0x4
    272e:	83c080e7          	jalr	-1988(ra) # 5f66 <printf>
    exit(1);
    2732:	4505                	li	a0,1
    ...
    2744:	23850513          	addi	a0,a0,568 # 6978 <malloc+0x954>
    2748:	00004097          	auipc	ra,0x4
    274c:	81e080e7          	jalr	-2018(ra) # 5f66 <printf>
    exit(1);
    2750:	4505                	li	a0,1
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	71c50513          	addi	a0,a0,1820 # 6ea8 <malloc+0xe84>
  ...
  if(n >= 0){
    ...
    27c2:	70a50513          	addi	a0,a0,1802 # 6ec8 <malloc+0xea4>
    27c6:	00003097          	auipc	ra,0x3
    27ca:	7a0080e7          	jalr	1952(ra) # 5f66 <printf>
    exit(1);
    27ce:	4505                	li	a0,1
    ...
    27dc:	69850513          	addi	a0,a0,1688 # 6e70 <malloc+0xe4c>
    27e0:	00003097          	auipc	ra,0x3
    27e4:	786080e7          	jalr	1926(ra) # 5f66 <printf>
    exit(1);
    27e8:	4505                	li	a0,1
    ...
    27f6:	69650513          	addi	a0,a0,1686 # 6e88 <malloc+0xe64>
    27fa:	00003097          	auipc	ra,0x3
    27fe:	76c080e7          	jalr	1900(ra) # 5f66 <printf>
    exit(1);
    2802:	4505                	li	a0,1
    ...
    2810:	6a450513          	addi	a0,a0,1700 # 6eb0 <malloc+0xe8c>
    2814:	00003097          	auipc	ra,0x3
    2818:	752080e7          	jalr	1874(ra) # 5f66 <printf>
    exit(1);
    281c:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2834:	67850513          	addi	a0,a0,1656 # 6ea8 <malloc+0xe84>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	afe50513          	addi	a0,a0,-1282 # 6340 <malloc+0x31c>
  ...
  if(n >= 0){
    ...
    2870:	68c50513          	addi	a0,a0,1676 # 6ef8 <malloc+0xed4>
    2874:	00003097          	auipc	ra,0x3
    2878:	6f2080e7          	jalr	1778(ra) # 5f66 <printf>
    exit(1);
    287c:	4505                	li	a0,1
    ...
    288a:	62a50513          	addi	a0,a0,1578 # 6eb0 <malloc+0xe8c>
    288e:	00003097          	auipc	ra,0x3
    2892:	6d8080e7          	jalr	1752(ra) # 5f66 <printf>
    exit(1);
    2896:	4505                	li	a0,1
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    290a:	61a50513          	addi	a0,a0,1562 # 6f20 <malloc+0xefc>
    290e:	00003097          	auipc	ra,0x3
    2912:	658080e7          	jalr	1624(ra) # 5f66 <printf>
    exit(1);
    2916:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	5e850513          	addi	a0,a0,1512 # 6f40 <malloc+0xf1c>
    2960:	00003097          	auipc	ra,0x3
    2964:	606080e7          	jalr	1542(ra) # 5f66 <printf>
    exit(1);
    2968:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29c0:	5e450513          	addi	a0,a0,1508 # 6fa0 <malloc+0xf7c>
    29c4:	00003097          	auipc	ra,0x3
    29c8:	5a2080e7          	jalr	1442(ra) # 5f66 <printf>
    exit(1);
    29cc:	4505                	li	a0,1
    ...
    29e2:	58250513          	addi	a0,a0,1410 # 6f60 <malloc+0xf3c>
    29e6:	00003097          	auipc	ra,0x3
    29ea:	580080e7          	jalr	1408(ra) # 5f66 <printf>
      exit(1);
    29ee:	4505                	li	a0,1
    ...
    29fe:	58650513          	addi	a0,a0,1414 # 6f80 <malloc+0xf5c>
    2a02:	00003097          	auipc	ra,0x3
    2a06:	564080e7          	jalr	1380(ra) # 5f66 <printf>
    exit(1);
    2a0a:	4505                	li	a0,1
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b48:	47c50513          	addi	a0,a0,1148 # 6fc0 <malloc+0xf9c>
    2b4c:	00003097          	auipc	ra,0x3
    2b50:	41a080e7          	jalr	1050(ra) # 5f66 <printf>
    exit(1);
    2b54:	4505                	li	a0,1
    ...
    2b64:	4a850513          	addi	a0,a0,1192 # 7008 <malloc+0xfe4>
    2b68:	00003097          	auipc	ra,0x3
    2b6c:	3fe080e7          	jalr	1022(ra) # 5f66 <printf>
    exit(1);
    2b70:	4505                	li	a0,1
    ...
    2b84:	4a850513          	addi	a0,a0,1192 # 7028 <malloc+0x1004>
    2b88:	00003097          	auipc	ra,0x3
    2b8c:	3de080e7          	jalr	990(ra) # 5f66 <printf>
    exit(1);
    2b90:	4505                	li	a0,1
    ...
    2ba4:	4c850513          	addi	a0,a0,1224 # 7068 <malloc+0x1044>
    2ba8:	00003097          	auipc	ra,0x3
    2bac:	3be080e7          	jalr	958(ra) # 5f66 <printf>
    exit(1);
    2bb0:	4505                	li	a0,1
    ...
    2bc0:	4dc50513          	addi	a0,a0,1244 # 7098 <malloc+0x1074>
    2bc4:	00003097          	auipc	ra,0x3
    2bc8:	3a2080e7          	jalr	930(ra) # 5f66 <printf>
    exit(1);
    2bcc:	4505                	li	a0,1
    ...
    2be0:	4f450513          	addi	a0,a0,1268 # 70d0 <malloc+0x10ac>
    2be4:	00003097          	auipc	ra,0x3
    2be8:	382080e7          	jalr	898(ra) # 5f66 <printf>
    exit(1);
    2bec:	4505                	li	a0,1
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	4e250513          	addi	a0,a0,1250 # 70f8 <malloc+0x10d4>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	4d050513          	addi	a0,a0,1232 # 70f8 <malloc+0x10d4>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	48450513          	addi	a0,a0,1156 # 7100 <malloc+0x10dc>
    2c84:	00003097          	auipc	ra,0x3
    2c88:	2e2080e7          	jalr	738(ra) # 5f66 <printf>
    exit(1);
    2c8c:	4505                	li	a0,1
    ...
    2c9c:	48050513          	addi	a0,a0,1152 # 7118 <malloc+0x10f4>
    2ca0:	00003097          	auipc	ra,0x3
    2ca4:	2c6080e7          	jalr	710(ra) # 5f66 <printf>
    exit(1);
    2ca8:	4505                	li	a0,1
    ...
    2cb8:	e4450513          	addi	a0,a0,-444 # 6af8 <malloc+0xad4>
    2cbc:	00003097          	auipc	ra,0x3
    2cc0:	2aa080e7          	jalr	682(ra) # 5f66 <printf>
    exit(1);
    2cc4:	4505                	li	a0,1
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	45250513          	addi	a0,a0,1106 # 7130 <malloc+0x110c>
  ...
  close(fd);
    ...
    2d2a:	ce250513          	addi	a0,a0,-798 # 6a08 <malloc+0x9e4>
    2d2e:	00003097          	auipc	ra,0x3
    2d32:	238080e7          	jalr	568(ra) # 5f66 <printf>
    exit(1);
    2d36:	4505                	li	a0,1
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	08450513          	addi	a0,a0,132 # 6df8 <malloc+0xdd4>
    2d7c:	00003097          	auipc	ra,0x3
    2d80:	1ea080e7          	jalr	490(ra) # 5f66 <printf>
    exit(1);
    2d84:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dce:	02e50513          	addi	a0,a0,46 # 6df8 <malloc+0xdd4>
    2dd2:	00003097          	auipc	ra,0x3
    2dd6:	194080e7          	jalr	404(ra) # 5f66 <printf>
    exit(1);
    2dda:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e2e:	fce50513          	addi	a0,a0,-50 # 6df8 <malloc+0xdd4>
    2e32:	00003097          	auipc	ra,0x3
    2e36:	134080e7          	jalr	308(ra) # 5f66 <printf>
    exit(1);
    2e3a:	4505                	li	a0,1
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	e5a50513          	addi	a0,a0,-422 # 6df8 <malloc+0xdd4>
    2fa6:	00003097          	auipc	ra,0x3
    2faa:	fc0080e7          	jalr	-64(ra) # 5f66 <printf>
      exit(1);
    2fae:	4505                	li	a0,1
    ...
    2ff6:	17650513          	addi	a0,a0,374 # 6168 <malloc+0x144>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	1da78793          	addi	a5,a5,474 # 61d8 <malloc+0x1b4>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	2d850513          	addi	a0,a0,728 # 7308 <malloc+0x12e4>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	11e50513          	addi	a0,a0,286 # 7160 <malloc+0x113c>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	16050513          	addi	a0,a0,352 # 71b8 <malloc+0x1194>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	1ba50513          	addi	a0,a0,442 # 7230 <malloc+0x120c>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	20e50513          	addi	a0,a0,526 # 72a0 <malloc+0x127c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	25450513          	addi	a0,a0,596 # 72f8 <malloc+0x12d4>
  ...
  unlink("12345678901234");
    ...
    3126:	01650513          	addi	a0,a0,22 # 7138 <malloc+0x1114>
    312a:	00003097          	auipc	ra,0x3
    312e:	e3c080e7          	jalr	-452(ra) # 5f66 <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    3142:	04250513          	addi	a0,a0,66 # 7180 <malloc+0x115c>
    3146:	00003097          	auipc	ra,0x3
    314a:	e20080e7          	jalr	-480(ra) # 5f66 <printf>
    exit(1);
    314e:	4505                	li	a0,1
    ...
    315e:	08e50513          	addi	a0,a0,142 # 71e8 <malloc+0x11c4>
    3162:	00003097          	auipc	ra,0x3
    3166:	e04080e7          	jalr	-508(ra) # 5f66 <printf>
    exit(1);
    316a:	4505                	li	a0,1
    ...
    317a:	0ea50513          	addi	a0,a0,234 # 7260 <malloc+0x123c>
    317e:	00003097          	auipc	ra,0x3
    3182:	de8080e7          	jalr	-536(ra) # 5f66 <printf>
    exit(1);
    3186:	4505                	li	a0,1
    ...
    3196:	12e50513          	addi	a0,a0,302 # 72c0 <malloc+0x129c>
    319a:	00003097          	auipc	ra,0x3
    319e:	dcc080e7          	jalr	-564(ra) # 5f66 <printf>
    exit(1);
    31a2:	4505                	li	a0,1
    ...
    31b2:	16a50513          	addi	a0,a0,362 # 7318 <malloc+0x12f4>
    31b6:	00003097          	auipc	ra,0x3
    31ba:	db0080e7          	jalr	-592(ra) # 5f66 <printf>
    exit(1);
    31be:	4505                	li	a0,1
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	15650513          	addi	a0,a0,342 # 7350 <malloc+0x132c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	13c50513          	addi	a0,a0,316 # 7360 <malloc+0x133c>
    322c:	00003097          	auipc	ra,0x3
    3230:	d3a080e7          	jalr	-710(ra) # 5f66 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	09c50513          	addi	a0,a0,156 # 7350 <malloc+0x132c>
  ...
  unlink("diskfulldir");
    ...
    32cc:	08850513          	addi	a0,a0,136 # 7350 <malloc+0x132c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	f8a50513          	addi	a0,a0,-118 # 7380 <malloc+0x135c>
    33fe:	00003097          	auipc	ra,0x3
    3402:	b68080e7          	jalr	-1176(ra) # 5f66 <printf>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	f9c50513          	addi	a0,a0,-100 # 73b0 <malloc+0x138c>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	f8850513          	addi	a0,a0,-120 # 73b0 <malloc+0x138c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	fb450513          	addi	a0,a0,-76 # 73f0 <malloc+0x13cc>
  ...
  if(chdir("/") < 0){
    ...
    3454:	fd050513          	addi	a0,a0,-48 # 7420 <malloc+0x13fc>
    ...
    3474:	f4850513          	addi	a0,a0,-184 # 73b8 <malloc+0x1394>
    3478:	00003097          	auipc	ra,0x3
    347c:	aee080e7          	jalr	-1298(ra) # 5f66 <printf>
    exit(1);
    3480:	4505                	li	a0,1
    ...
    3490:	f4450513          	addi	a0,a0,-188 # 73d0 <malloc+0x13ac>
    3494:	00003097          	auipc	ra,0x3
    3498:	ad2080e7          	jalr	-1326(ra) # 5f66 <printf>
    exit(1);
    349c:	4505                	li	a0,1
    ...
    34ac:	f5850513          	addi	a0,a0,-168 # 7400 <malloc+0x13dc>
    34b0:	00003097          	auipc	ra,0x3
    34b4:	ab6080e7          	jalr	-1354(ra) # 5f66 <printf>
    exit(1);
    34b8:	4505                	li	a0,1
    ...
    34c8:	f6450513          	addi	a0,a0,-156 # 7428 <malloc+0x1404>
    34cc:	00003097          	auipc	ra,0x3
    34d0:	a9a080e7          	jalr	-1382(ra) # 5f66 <printf>
    exit(1);
    34d4:	4505                	li	a0,1
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	eb850513          	addi	a0,a0,-328 # 73b0 <malloc+0x138c>
    ...
    3510:	ea450513          	addi	a0,a0,-348 # 73b0 <malloc+0x138c>
    ...
    3524:	ed050513          	addi	a0,a0,-304 # 73f0 <malloc+0x13cc>
    ...
    3544:	4b050513          	addi	a0,a0,1200 # 69f0 <malloc+0x9cc>
    3548:	00003097          	auipc	ra,0x3
    354c:	a1e080e7          	jalr	-1506(ra) # 5f66 <printf>
    exit(1);
    3550:	4505                	li	a0,1
    ...
    3560:	e5c50513          	addi	a0,a0,-420 # 73b8 <malloc+0x1394>
    3564:	00003097          	auipc	ra,0x3
    3568:	a02080e7          	jalr	-1534(ra) # 5f66 <printf>
      exit(1);
    356c:	4505                	li	a0,1
    ...
    357c:	ec850513          	addi	a0,a0,-312 # 7440 <malloc+0x141c>
    3580:	00003097          	auipc	ra,0x3
    3584:	9e6080e7          	jalr	-1562(ra) # 5f66 <printf>
      exit(1);
    3588:	4505                	li	a0,1
    ...
    3598:	e6c50513          	addi	a0,a0,-404 # 7400 <malloc+0x13dc>
    359c:	00003097          	auipc	ra,0x3
    35a0:	9ca080e7          	jalr	-1590(ra) # 5f66 <printf>
      exit(1);
    35a4:	4505                	li	a0,1
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	e8650513          	addi	a0,a0,-378 # 7458 <malloc+0x1434>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	e7250513          	addi	a0,a0,-398 # 7458 <malloc+0x1434>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	e7e50513          	addi	a0,a0,-386 # 7478 <malloc+0x1454>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	e4a50513          	addi	a0,a0,-438 # 7458 <malloc+0x1434>
    ...
    3632:	d8a50513          	addi	a0,a0,-630 # 73b8 <malloc+0x1394>
    3636:	00003097          	auipc	ra,0x3
    363a:	930080e7          	jalr	-1744(ra) # 5f66 <printf>
    exit(1);
    363e:	4505                	li	a0,1
    ...
    364e:	e1650513          	addi	a0,a0,-490 # 7460 <malloc+0x143c>
    3652:	00003097          	auipc	ra,0x3
    3656:	914080e7          	jalr	-1772(ra) # 5f66 <printf>
    exit(1);
    365a:	4505                	li	a0,1
    ...
    366a:	e1a50513          	addi	a0,a0,-486 # 7480 <malloc+0x145c>
    366e:	00003097          	auipc	ra,0x3
    3672:	8f8080e7          	jalr	-1800(ra) # 5f66 <printf>
    exit(1);
    3676:	4505                	li	a0,1
    ...
    3686:	e1650513          	addi	a0,a0,-490 # 7498 <malloc+0x1474>
    368a:	00003097          	auipc	ra,0x3
    368e:	8dc080e7          	jalr	-1828(ra) # 5f66 <printf>
    exit(1);
    3692:	4505                	li	a0,1
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	f3650513          	addi	a0,a0,-202 # 75e0 <malloc+0x15bc>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	df650513          	addi	a0,a0,-522 # 74b0 <malloc+0x148c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	dfe50513          	addi	a0,a0,-514 # 74d0 <malloc+0x14ac>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	ef658593          	addi	a1,a1,-266 # 75e0 <malloc+0x15bc>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	dac50513          	addi	a0,a0,-596 # 74b0 <malloc+0x148c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	e1050513          	addi	a0,a0,-496 # 7528 <malloc+0x1504>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	e2050513          	addi	a0,a0,-480 # 7550 <malloc+0x152c>
  ...
  write(fd, "FF", 2);
    ...
    374c:	e3858593          	addi	a1,a1,-456 # 7580 <malloc+0x155c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	e2450513          	addi	a0,a0,-476 # 7588 <malloc+0x1564>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	e2c58593          	addi	a1,a1,-468 # 75d8 <malloc+0x15b4>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	d9c50513          	addi	a0,a0,-612 # 7550 <malloc+0x152c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	d8850513          	addi	a0,a0,-632 # 7550 <malloc+0x152c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	d7250513          	addi	a0,a0,-654 # 7550 <malloc+0x152c>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	cbe50513          	addi	a0,a0,-834 # 74b0 <malloc+0x148c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	e6a50513          	addi	a0,a0,-406 # 7670 <malloc+0x164c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	e8650513          	addi	a0,a0,-378 # 76a0 <malloc+0x167c>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	ea250513          	addi	a0,a0,-350 # 76d0 <malloc+0x16ac>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	d9450513          	addi	a0,a0,-620 # 75d8 <malloc+0x15b4>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	cd250513          	addi	a0,a0,-814 # 7550 <malloc+0x152c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	eca50513          	addi	a0,a0,-310 # 7760 <malloc+0x173c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	ee250513          	addi	a0,a0,-286 # 7790 <malloc+0x176c>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	bea50513          	addi	a0,a0,-1046 # 74b0 <malloc+0x148c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	bd450513          	addi	a0,a0,-1068 # 74b0 <malloc+0x148c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	bbe50513          	addi	a0,a0,-1090 # 74b0 <malloc+0x148c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	f1a58593          	addi	a1,a1,-230 # 7820 <malloc+0x17fc>
    390e:	00004517          	auipc	a0,0x4
    3912:	e5250513          	addi	a0,a0,-430 # 7760 <malloc+0x173c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	efe58593          	addi	a1,a1,-258 # 7820 <malloc+0x17fc>
    392a:	00004517          	auipc	a0,0x4
    392e:	e6650513          	addi	a0,a0,-410 # 7790 <malloc+0x176c>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	c9a58593          	addi	a1,a1,-870 # 75d8 <malloc+0x15b4>
    3946:	00004517          	auipc	a0,0x4
    394a:	b8a50513          	addi	a0,a0,-1142 # 74d0 <malloc+0x14ac>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	e0650513          	addi	a0,a0,-506 # 7760 <malloc+0x173c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	e2250513          	addi	a0,a0,-478 # 7790 <malloc+0x176c>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	c5650513          	addi	a0,a0,-938 # 75d8 <malloc+0x15b4>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	dfa50513          	addi	a0,a0,-518 # 7790 <malloc+0x176c>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	db650513          	addi	a0,a0,-586 # 7760 <malloc+0x173c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	b1250513          	addi	a0,a0,-1262 # 74d0 <malloc+0x14ac>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	f9e50513          	addi	a0,a0,-98 # 7970 <malloc+0x194c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	bf250513          	addi	a0,a0,-1038 # 75d8 <malloc+0x15b4>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	ad650513          	addi	a0,a0,-1322 # 74d0 <malloc+0x14ac>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	aa250513          	addi	a0,a0,-1374 # 74b0 <malloc+0x148c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	fbe50513          	addi	a0,a0,-66 # 79e0 <malloc+0x19bc>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	a7a50513          	addi	a0,a0,-1414 # 74b0 <malloc+0x148c>
    ...
    3a5c:	a6050513          	addi	a0,a0,-1440 # 74b8 <malloc+0x1494>
    3a60:	00002097          	auipc	ra,0x2
    3a64:	506080e7          	jalr	1286(ra) # 5f66 <printf>
    exit(1);
    3a68:	4505                	li	a0,1
    ...
    3a78:	a6450513          	addi	a0,a0,-1436 # 74d8 <malloc+0x14b4>
    3a7c:	00002097          	auipc	ra,0x2
    3a80:	4ea080e7          	jalr	1258(ra) # 5f66 <printf>
    exit(1);
    3a84:	4505                	li	a0,1
    ...
    3a94:	a6850513          	addi	a0,a0,-1432 # 74f8 <malloc+0x14d4>
    3a98:	00002097          	auipc	ra,0x2
    3a9c:	4ce080e7          	jalr	1230(ra) # 5f66 <printf>
    exit(1);
    3aa0:	4505                	li	a0,1
    ...
    3ab0:	a8450513          	addi	a0,a0,-1404 # 7530 <malloc+0x150c>
    3ab4:	00002097          	auipc	ra,0x2
    3ab8:	4b2080e7          	jalr	1202(ra) # 5f66 <printf>
    exit(1);
    3abc:	4505                	li	a0,1
    ...
    3acc:	a9850513          	addi	a0,a0,-1384 # 7560 <malloc+0x153c>
    3ad0:	00002097          	auipc	ra,0x2
    3ad4:	496080e7          	jalr	1174(ra) # 5f66 <printf>
    exit(1);
    3ad8:	4505                	li	a0,1
    ...
    3ae8:	ab450513          	addi	a0,a0,-1356 # 7598 <malloc+0x1574>
    3aec:	00002097          	auipc	ra,0x2
    3af0:	47a080e7          	jalr	1146(ra) # 5f66 <printf>
    exit(1);
    3af4:	4505                	li	a0,1
    ...
    3b04:	ab850513          	addi	a0,a0,-1352 # 75b8 <malloc+0x1594>
    3b08:	00002097          	auipc	ra,0x2
    3b0c:	45e080e7          	jalr	1118(ra) # 5f66 <printf>
    exit(1);
    3b10:	4505                	li	a0,1
    ...
    3b20:	acc50513          	addi	a0,a0,-1332 # 75e8 <malloc+0x15c4>
    3b24:	00002097          	auipc	ra,0x2
    3b28:	442080e7          	jalr	1090(ra) # 5f66 <printf>
    exit(1);
    3b2c:	4505                	li	a0,1
    ...
    3b3c:	ad850513          	addi	a0,a0,-1320 # 7610 <malloc+0x15ec>
    3b40:	00002097          	auipc	ra,0x2
    3b44:	426080e7          	jalr	1062(ra) # 5f66 <printf>
    exit(1);
    3b48:	4505                	li	a0,1
    ...
    3b58:	adc50513          	addi	a0,a0,-1316 # 7630 <malloc+0x160c>
    3b5c:	00002097          	auipc	ra,0x2
    3b60:	40a080e7          	jalr	1034(ra) # 5f66 <printf>
    exit(1);
    3b64:	4505                	li	a0,1
    ...
    3b74:	ae850513          	addi	a0,a0,-1304 # 7658 <malloc+0x1634>
    3b78:	00002097          	auipc	ra,0x2
    3b7c:	3ee080e7          	jalr	1006(ra) # 5f66 <printf>
    exit(1);
    3b80:	4505                	li	a0,1
    ...
    3b90:	af450513          	addi	a0,a0,-1292 # 7680 <malloc+0x165c>
    3b94:	00002097          	auipc	ra,0x2
    3b98:	3d2080e7          	jalr	978(ra) # 5f66 <printf>
    exit(1);
    3b9c:	4505                	li	a0,1
    ...
    3bac:	b0850513          	addi	a0,a0,-1272 # 76b0 <malloc+0x168c>
    3bb0:	00002097          	auipc	ra,0x2
    3bb4:	3b6080e7          	jalr	950(ra) # 5f66 <printf>
    exit(1);
    3bb8:	4505                	li	a0,1
    ...
    3bc8:	b1450513          	addi	a0,a0,-1260 # 76d8 <malloc+0x16b4>
    3bcc:	00002097          	auipc	ra,0x2
    3bd0:	39a080e7          	jalr	922(ra) # 5f66 <printf>
    exit(1);
    3bd4:	4505                	li	a0,1
    ...
    3be4:	b1050513          	addi	a0,a0,-1264 # 76f0 <malloc+0x16cc>
    3be8:	00002097          	auipc	ra,0x2
    3bec:	37e080e7          	jalr	894(ra) # 5f66 <printf>
    exit(1);
    3bf0:	4505                	li	a0,1
    ...
    3c00:	b1450513          	addi	a0,a0,-1260 # 7710 <malloc+0x16ec>
    3c04:	00002097          	auipc	ra,0x2
    3c08:	362080e7          	jalr	866(ra) # 5f66 <printf>
    exit(1);
    3c0c:	4505                	li	a0,1
    ...
    3c1c:	b1850513          	addi	a0,a0,-1256 # 7730 <malloc+0x170c>
    3c20:	00002097          	auipc	ra,0x2
    3c24:	346080e7          	jalr	838(ra) # 5f66 <printf>
    exit(1);
    3c28:	4505                	li	a0,1
    ...
    3c38:	b3c50513          	addi	a0,a0,-1220 # 7770 <malloc+0x174c>
    3c3c:	00002097          	auipc	ra,0x2
    3c40:	32a080e7          	jalr	810(ra) # 5f66 <printf>
    exit(1);
    3c44:	4505                	li	a0,1
    ...
    3c54:	b5050513          	addi	a0,a0,-1200 # 77a0 <malloc+0x177c>
    3c58:	00002097          	auipc	ra,0x2
    3c5c:	30e080e7          	jalr	782(ra) # 5f66 <printf>
    exit(1);
    3c60:	4505                	li	a0,1
    ...
    3c70:	b5450513          	addi	a0,a0,-1196 # 77c0 <malloc+0x179c>
    3c74:	00002097          	auipc	ra,0x2
    3c78:	2f2080e7          	jalr	754(ra) # 5f66 <printf>
    exit(1);
    3c7c:	4505                	li	a0,1
    ...
    3c8c:	b5850513          	addi	a0,a0,-1192 # 77e0 <malloc+0x17bc>
    3c90:	00002097          	auipc	ra,0x2
    3c94:	2d6080e7          	jalr	726(ra) # 5f66 <printf>
    exit(1);
    3c98:	4505                	li	a0,1
    ...
    3ca8:	b5c50513          	addi	a0,a0,-1188 # 7800 <malloc+0x17dc>
    3cac:	00002097          	auipc	ra,0x2
    3cb0:	2ba080e7          	jalr	698(ra) # 5f66 <printf>
    exit(1);
    3cb4:	4505                	li	a0,1
    ...
    3cc4:	b7050513          	addi	a0,a0,-1168 # 7830 <malloc+0x180c>
    3cc8:	00002097          	auipc	ra,0x2
    3ccc:	29e080e7          	jalr	670(ra) # 5f66 <printf>
    exit(1);
    3cd0:	4505                	li	a0,1
    ...
    3ce0:	b7c50513          	addi	a0,a0,-1156 # 7858 <malloc+0x1834>
    3ce4:	00002097          	auipc	ra,0x2
    3ce8:	282080e7          	jalr	642(ra) # 5f66 <printf>
    exit(1);
    3cec:	4505                	li	a0,1
    ...
    3cfc:	b8850513          	addi	a0,a0,-1144 # 7880 <malloc+0x185c>
    3d00:	00002097          	auipc	ra,0x2
    3d04:	266080e7          	jalr	614(ra) # 5f66 <printf>
    exit(1);
    3d08:	4505                	li	a0,1
    ...
    3d18:	b9450513          	addi	a0,a0,-1132 # 78a8 <malloc+0x1884>
    3d1c:	00002097          	auipc	ra,0x2
    3d20:	24a080e7          	jalr	586(ra) # 5f66 <printf>
    exit(1);
    3d24:	4505                	li	a0,1
    ...
    3d34:	b9850513          	addi	a0,a0,-1128 # 78c8 <malloc+0x18a4>
    3d38:	00002097          	auipc	ra,0x2
    3d3c:	22e080e7          	jalr	558(ra) # 5f66 <printf>
    exit(1);
    3d40:	4505                	li	a0,1
    ...
    3d50:	b9c50513          	addi	a0,a0,-1124 # 78e8 <malloc+0x18c4>
    3d54:	00002097          	auipc	ra,0x2
    3d58:	212080e7          	jalr	530(ra) # 5f66 <printf>
    exit(1);
    3d5c:	4505                	li	a0,1
    ...
    3d6c:	ba850513          	addi	a0,a0,-1112 # 7910 <malloc+0x18ec>
    3d70:	00002097          	auipc	ra,0x2
    3d74:	1f6080e7          	jalr	502(ra) # 5f66 <printf>
    exit(1);
    3d78:	4505                	li	a0,1
    ...
    3d88:	bac50513          	addi	a0,a0,-1108 # 7930 <malloc+0x190c>
    3d8c:	00002097          	auipc	ra,0x2
    3d90:	1da080e7          	jalr	474(ra) # 5f66 <printf>
    exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da4:	bb050513          	addi	a0,a0,-1104 # 7950 <malloc+0x192c>
    3da8:	00002097          	auipc	ra,0x2
    3dac:	1be080e7          	jalr	446(ra) # 5f66 <printf>
    exit(1);
    3db0:	4505                	li	a0,1
    ...
    3dc0:	bbc50513          	addi	a0,a0,-1092 # 7978 <malloc+0x1954>
    3dc4:	00002097          	auipc	ra,0x2
    3dc8:	1a2080e7          	jalr	418(ra) # 5f66 <printf>
    exit(1);
    3dcc:	4505                	li	a0,1
    ...
    3ddc:	83850513          	addi	a0,a0,-1992 # 7610 <malloc+0x15ec>
    3de0:	00002097          	auipc	ra,0x2
    3de4:	186080e7          	jalr	390(ra) # 5f66 <printf>
    exit(1);
    3de8:	4505                	li	a0,1
    ...
    3df8:	ba450513          	addi	a0,a0,-1116 # 7998 <malloc+0x1974>
    3dfc:	00002097          	auipc	ra,0x2
    3e00:	16a080e7          	jalr	362(ra) # 5f66 <printf>
    exit(1);
    3e04:	4505                	li	a0,1
    ...
    3e14:	ba850513          	addi	a0,a0,-1112 # 79b8 <malloc+0x1994>
    3e18:	00002097          	auipc	ra,0x2
    3e1c:	14e080e7          	jalr	334(ra) # 5f66 <printf>
    exit(1);
    3e20:	4505                	li	a0,1
    ...
    3e30:	bbc50513          	addi	a0,a0,-1092 # 79e8 <malloc+0x19c4>
    3e34:	00002097          	auipc	ra,0x2
    3e38:	132080e7          	jalr	306(ra) # 5f66 <printf>
    exit(1);
    3e3c:	4505                	li	a0,1
    ...
    3e4c:	bc050513          	addi	a0,a0,-1088 # 7a08 <malloc+0x19e4>
    3e50:	00002097          	auipc	ra,0x2
    3e54:	116080e7          	jalr	278(ra) # 5f66 <printf>
    exit(1);
    3e58:	4505                	li	a0,1
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	bb250513          	addi	a0,a0,-1102 # 7a20 <malloc+0x19fc>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	ba050513          	addi	a0,a0,-1120 # 7a20 <malloc+0x19fc>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	9be50513          	addi	a0,a0,-1602 # 6850 <malloc+0x82c>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	5d450513          	addi	a0,a0,1492 # 7478 <malloc+0x1454>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	56a50513          	addi	a0,a0,1386 # 7420 <malloc+0x13fc>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	bc050513          	addi	a0,a0,-1088 # 7a88 <malloc+0x1a64>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	bd650513          	addi	a0,a0,-1066 # 7ab0 <malloc+0x1a8c>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	b3450513          	addi	a0,a0,-1228 # 7a20 <malloc+0x19fc>
    ...
    3f0e:	b1e50513          	addi	a0,a0,-1250 # 7a28 <malloc+0x1a04>
    3f12:	00002097          	auipc	ra,0x2
    3f16:	054080e7          	jalr	84(ra) # 5f66 <printf>
    exit(1);
    3f1a:	4505                	li	a0,1
    ...
    3f2a:	b1a50513          	addi	a0,a0,-1254 # 7a40 <malloc+0x1a1c>
    3f2e:	00002097          	auipc	ra,0x2
    3f32:	038080e7          	jalr	56(ra) # 5f66 <printf>
    exit(1);
    3f36:	4505                	li	a0,1
    ...
    3f46:	b1650513          	addi	a0,a0,-1258 # 7a58 <malloc+0x1a34>
    3f4a:	00002097          	auipc	ra,0x2
    3f4e:	01c080e7          	jalr	28(ra) # 5f66 <printf>
    exit(1);
    3f52:	4505                	li	a0,1
    ...
    3f62:	b1250513          	addi	a0,a0,-1262 # 7a70 <malloc+0x1a4c>
    3f66:	00002097          	auipc	ra,0x2
    3f6a:	000080e7          	jalr	ra # 5f66 <printf>
    exit(1);
    3f6e:	4505                	li	a0,1
    ...
    3f7e:	4ae50513          	addi	a0,a0,1198 # 7428 <malloc+0x1404>
    3f82:	00002097          	auipc	ra,0x2
    3f86:	fe4080e7          	jalr	-28(ra) # 5f66 <printf>
    exit(1);
    3f8a:	4505                	li	a0,1
    ...
    3f9a:	afa50513          	addi	a0,a0,-1286 # 7a90 <malloc+0x1a6c>
    3f9e:	00002097          	auipc	ra,0x2
    3fa2:	fc8080e7          	jalr	-56(ra) # 5f66 <printf>
    exit(1);
    3fa6:	4505                	li	a0,1
    ...
    3fb6:	b0650513          	addi	a0,a0,-1274 # 7ab8 <malloc+0x1a94>
    3fba:	00002097          	auipc	ra,0x2
    3fbe:	fac080e7          	jalr	-84(ra) # 5f66 <printf>
    exit(1);
    3fc2:	4505                	li	a0,1
    ...
    3fd2:	b0a50513          	addi	a0,a0,-1270 # 7ad8 <malloc+0x1ab4>
    3fd6:	00002097          	auipc	ra,0x2
    3fda:	f90080e7          	jalr	-112(ra) # 5f66 <printf>
    exit(1);
    3fde:	4505                	li	a0,1
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	afe50513          	addi	a0,a0,-1282 # 7af8 <malloc+0x1ad4>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	ae250513          	addi	a0,a0,-1310 # 7af8 <malloc+0x1ad4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	b1650513          	addi	a0,a0,-1258 # 7b40 <malloc+0x1b1c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	afe50513          	addi	a0,a0,-1282 # 7b40 <malloc+0x1b1c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	aea50513          	addi	a0,a0,-1302 # 7b40 <malloc+0x1b1c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	ad650513          	addi	a0,a0,-1322 # 7b40 <malloc+0x1b1c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	ac258593          	addi	a1,a1,-1342 # 7b40 <malloc+0x1b1c>
    4086:	00002517          	auipc	a0,0x2
    408a:	2ba50513          	addi	a0,a0,698 # 6340 <malloc+0x31c>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	a5e50513          	addi	a0,a0,-1442 # 7af8 <malloc+0x1ad4>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	7a050513          	addi	a0,a0,1952 # 6850 <malloc+0x82c>
  ...
  fd = open(".", 0);
    ...
    40ca:	78a50513          	addi	a0,a0,1930 # 6850 <malloc+0x82c>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	0fe58593          	addi	a1,a1,254 # 61d8 <malloc+0x1b4>
  ...
  close(fd);
    ...
    410a:	9fa50513          	addi	a0,a0,-1542 # 7b00 <malloc+0x1adc>
    410e:	00002097          	auipc	ra,0x2
    4112:	e58080e7          	jalr	-424(ra) # 5f66 <printf>
    exit(1);
    4116:	4505                	li	a0,1
    ...
    4126:	9fe50513          	addi	a0,a0,-1538 # 7b20 <malloc+0x1afc>
    412a:	00002097          	auipc	ra,0x2
    412e:	e3c080e7          	jalr	-452(ra) # 5f66 <printf>
    exit(1);
    4132:	4505                	li	a0,1
    ...
    4142:	a1250513          	addi	a0,a0,-1518 # 7b50 <malloc+0x1b2c>
    4146:	00002097          	auipc	ra,0x2
    414a:	e20080e7          	jalr	-480(ra) # 5f66 <printf>
    exit(1);
    414e:	4505                	li	a0,1
    ...
    415e:	9f650513          	addi	a0,a0,-1546 # 7b50 <malloc+0x1b2c>
    4162:	00002097          	auipc	ra,0x2
    4166:	e04080e7          	jalr	-508(ra) # 5f66 <printf>
    exit(1);
    416a:	4505                	li	a0,1
    ...
    417a:	a0250513          	addi	a0,a0,-1534 # 7b78 <malloc+0x1b54>
    417e:	00002097          	auipc	ra,0x2
    4182:	de8080e7          	jalr	-536(ra) # 5f66 <printf>
    exit(1);
    4186:	4505                	li	a0,1
    ...
    4196:	a0e50513          	addi	a0,a0,-1522 # 7ba0 <malloc+0x1b7c>
    419a:	00002097          	auipc	ra,0x2
    419e:	dcc080e7          	jalr	-564(ra) # 5f66 <printf>
    exit(1);
    41a2:	4505                	li	a0,1
    ...
    41b2:	a1a50513          	addi	a0,a0,-1510 # 7bc8 <malloc+0x1ba4>
    41b6:	00002097          	auipc	ra,0x2
    41ba:	db0080e7          	jalr	-592(ra) # 5f66 <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ce:	a2650513          	addi	a0,a0,-1498 # 7bf0 <malloc+0x1bcc>
    41d2:	00002097          	auipc	ra,0x2
    41d6:	d94080e7          	jalr	-620(ra) # 5f66 <printf>
    exit(1);
    41da:	4505                	li	a0,1
    ...
    41ea:	a2a50513          	addi	a0,a0,-1494 # 7c10 <malloc+0x1bec>
    41ee:	00002097          	auipc	ra,0x2
    41f2:	d78080e7          	jalr	-648(ra) # 5f66 <printf>
    exit(1);
    41f6:	4505                	li	a0,1
    ...
    4206:	a3650513          	addi	a0,a0,-1482 # 7c38 <malloc+0x1c14>
    420a:	00002097          	auipc	ra,0x2
    420e:	d5c080e7          	jalr	-676(ra) # 5f66 <printf>
    exit(1);
    4212:	4505                	li	a0,1
...
000000000000421c <iref>:
{
    ...
    423a:	a1aa0a13          	addi	s4,s4,-1510 # 7c50 <malloc+0x1c2c>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	51a48493          	addi	s1,s1,1306 # 7758 <malloc+0x1734>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	0faa8a93          	addi	s5,s5,250 # 6340 <malloc+0x31c>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	8fa98993          	addi	s3,s3,-1798 # 7b48 <malloc+0x1b24>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	9fe50513          	addi	a0,a0,-1538 # 7c58 <malloc+0x1c34>
    4262:	00002097          	auipc	ra,0x2
    4266:	d04080e7          	jalr	-764(ra) # 5f66 <printf>
      exit(1);
    426a:	4505                	li	a0,1
    ...
    427a:	9fa50513          	addi	a0,a0,-1542 # 7c70 <malloc+0x1c4c>
    427e:	00002097          	auipc	ra,0x2
    4282:	ce8080e7          	jalr	-792(ra) # 5f66 <printf>
      exit(1);
    4286:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	16e98993          	addi	s3,s3,366 # 7478 <malloc+0x1454>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	93e90913          	addi	s2,s2,-1730 # 7c50 <malloc+0x1c2c>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	0ee50513          	addi	a0,a0,238 # 7420 <malloc+0x13fc>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	92650513          	addi	a0,a0,-1754 # 7c88 <malloc+0x1c64>
  ...
  if(pid == 0){
    ...
    438a:	90250513          	addi	a0,a0,-1790 # 7c88 <malloc+0x1c64>
    ...
    43a0:	90c50513          	addi	a0,a0,-1780 # 7ca8 <malloc+0x1c84>
    43a4:	00002097          	auipc	ra,0x2
    43a8:	bc2080e7          	jalr	-1086(ra) # 5f66 <printf>
      exit(1);
    43ac:	4505                	li	a0,1
    ...
    43bc:	8d850513          	addi	a0,a0,-1832 # 7c90 <malloc+0x1c6c>
    43c0:	00002097          	auipc	ra,0x2
    43c4:	ba6080e7          	jalr	-1114(ra) # 5f66 <printf>
    exit(1);
    43c8:	4505                	li	a0,1
    ...
    43d8:	61c50513          	addi	a0,a0,1564 # 69f0 <malloc+0x9cc>
    43dc:	00002097          	auipc	ra,0x2
    43e0:	b8a080e7          	jalr	-1142(ra) # 5f66 <printf>
    exit(1);
    43e4:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	88650513          	addi	a0,a0,-1914 # 7c88 <malloc+0x1c64>
    ...
    441a:	7ca50513          	addi	a0,a0,1994 # 6be0 <malloc+0xbbc>
    441e:	00002097          	auipc	ra,0x2
    4422:	b48080e7          	jalr	-1208(ra) # 5f66 <printf>
    exit(1);
    4426:	4505                	li	a0,1
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	87c50513          	addi	a0,a0,-1924 # 7cd0 <malloc+0x1cac>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	85050513          	addi	a0,a0,-1968 # 7cd0 <malloc+0x1cac>
  ...
  sleep(10); // one second
    ...
    44bc:	6f850513          	addi	a0,a0,1784 # 6bb0 <malloc+0xb8c>
    44c0:	00002097          	auipc	ra,0x2
    44c4:	aa6080e7          	jalr	-1370(ra) # 5f66 <printf>
    exit(1);
    44c8:	4505                	li	a0,1
    ...
    44d6:	7fe48493          	addi	s1,s1,2046 # 7cd0 <malloc+0x1cac>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	47650513          	addi	a0,a0,1142 # 69f0 <malloc+0x9cc>
    4582:	00002097          	auipc	ra,0x2
    4586:	9e4080e7          	jalr	-1564(ra) # 5f66 <printf>
      exit(1);
    458a:	4505                	li	a0,1
    ...
    45a4:	74050513          	addi	a0,a0,1856 # 7ce0 <malloc+0x1cbc>
    45a8:	00002097          	auipc	ra,0x2
    45ac:	9be080e7          	jalr	-1602(ra) # 5f66 <printf>
       exit(1);
    45b0:	4505                	li	a0,1
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	5d050513          	addi	a0,a0,1488 # 6bb0 <malloc+0xb8c>
    45e8:	00002097          	auipc	ra,0x2
    45ec:	97e080e7          	jalr	-1666(ra) # 5f66 <printf>
    exit(1);
    45f0:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    4612:	3e250513          	addi	a0,a0,994 # 69f0 <malloc+0x9cc>
    4616:	00002097          	auipc	ra,0x2
    461a:	950080e7          	jalr	-1712(ra) # 5f66 <printf>
    exit(1);
    461e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4656:	b8658593          	addi	a1,a1,-1146 # 61d8 <malloc+0x1b4>
    ...
    4680:	37450513          	addi	a0,a0,884 # 69f0 <malloc+0x9cc>
    4684:	00002097          	auipc	ra,0x2
    4688:	8e2080e7          	jalr	-1822(ra) # 5f66 <printf>
     exit(1);
    468c:	4505                	li	a0,1
    ...
    469c:	66850513          	addi	a0,a0,1640 # 7d00 <malloc+0x1cdc>
    46a0:	00002097          	auipc	ra,0x2
    46a4:	8c6080e7          	jalr	-1850(ra) # 5f66 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	64450513          	addi	a0,a0,1604 # 7d18 <malloc+0x1cf4>
    46dc:	00002097          	auipc	ra,0x2
    46e0:	88a080e7          	jalr	-1910(ra) # 5f66 <printf>
}
  ...
  printf("kill... ");
    ...
    4704:	63050513          	addi	a0,a0,1584 # 7d30 <malloc+0x1d0c>
    4708:	00002097          	auipc	ra,0x2
    470c:	85e080e7          	jalr	-1954(ra) # 5f66 <printf>
  kill(pid1);
    4710:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4732:	61250513          	addi	a0,a0,1554 # 7d40 <malloc+0x1d1c>
    4736:	00002097          	auipc	ra,0x2
    473a:	830080e7          	jalr	-2000(ra) # 5f66 <printf>
  wait(0);
    473e:	4501                	li	a0,0
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	24250513          	addi	a0,a0,578 # 69f0 <malloc+0x9cc>
    47b6:	00001097          	auipc	ra,0x1
    47ba:	7b0080e7          	jalr	1968(ra) # 5f66 <printf>
      exit(1);
    47be:	4505                	li	a0,1
    ...
    47ce:	3ae50513          	addi	a0,a0,942 # 6b78 <malloc+0xb54>
    47d2:	00001097          	auipc	ra,0x1
    47d6:	794080e7          	jalr	1940(ra) # 5f66 <printf>
        exit(1);
    47da:	4505                	li	a0,1
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	2b850513          	addi	a0,a0,696 # 6af8 <malloc+0xad4>
    4848:	00001097          	auipc	ra,0x1
    484c:	71e080e7          	jalr	1822(ra) # 5f66 <printf>
    exit(1);
    4850:	4505                	li	a0,1
    ...
    4878:	96458593          	addi	a1,a1,-1692 # 61d8 <malloc+0x1b4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	41850513          	addi	a0,a0,1048 # 7d50 <malloc+0x1d2c>
    4940:	00001097          	auipc	ra,0x1
    4944:	626080e7          	jalr	1574(ra) # 5f66 <printf>
    exit(1);
    4948:	4505                	li	a0,1
    ...
    4958:	09c50513          	addi	a0,a0,156 # 69f0 <malloc+0x9cc>
    495c:	00001097          	auipc	ra,0x1
    4960:	60a080e7          	jalr	1546(ra) # 5f66 <printf>
    exit(1);
    4964:	4505                	li	a0,1
    ...
    49a4:	3d050513          	addi	a0,a0,976 # 7d70 <malloc+0x1d4c>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	5be080e7          	jalr	1470(ra) # 5f66 <printf>
    exit(1);
    49b0:	4505                	li	a0,1
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0e:	61a080e7          	jalr	1562(ra) # 6024 <malloc>
    ...
    4a48:	35c50513          	addi	a0,a0,860 # 7da0 <malloc+0x1d7c>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	51a080e7          	jalr	1306(ra) # 5f66 <printf>
      exit(1);
    4a54:	4505                	li	a0,1
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	2d650513          	addi	a0,a0,726 # 7dd0 <malloc+0x1dac>
    4b02:	00001097          	auipc	ra,0x1
    4b06:	464080e7          	jalr	1124(ra) # 5f66 <printf>
    exit(1);
    4b0a:	4505                	li	a0,1
    ...
    4b1a:	2e250513          	addi	a0,a0,738 # 7df8 <malloc+0x1dd4>
    4b1e:	00001097          	auipc	ra,0x1
    4b22:	448080e7          	jalr	1096(ra) # 5f66 <printf>
      exit(1);
    4b26:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	26650513          	addi	a0,a0,614 # 7dc0 <malloc+0x1d9c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	27e50513          	addi	a0,a0,638 # 7e18 <malloc+0x1df4>
    4ba2:	00001097          	auipc	ra,0x1
    4ba6:	3c4080e7          	jalr	964(ra) # 5f66 <printf>
    exit(1);
    4baa:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bda:	1ea50513          	addi	a0,a0,490 # 7dc0 <malloc+0x1d9c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	24450513          	addi	a0,a0,580 # 7e40 <malloc+0x1e1c>
    4c04:	00001097          	auipc	ra,0x1
    4c08:	362080e7          	jalr	866(ra) # 5f66 <printf>
    exit(1);
    4c0c:	4505                	li	a0,1
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	4ce78793          	addi	a5,a5,1230 # 6110 <malloc+0xec>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	4ca78793          	addi	a5,a5,1226 # 6118 <malloc+0xf4>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	4c678793          	addi	a5,a5,1222 # 6120 <malloc+0xfc>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	4c278793          	addi	a5,a5,1218 # 6128 <malloc+0x104>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	11a50513          	addi	a0,a0,282 # 6df8 <malloc+0xdd4>
    4ce6:	00001097          	auipc	ra,0x1
    4cea:	280080e7          	jalr	640(ra) # 5f66 <printf>
      exit(1);
    4cee:	4505                	li	a0,1
    ...
    4d5e:	0fe50513          	addi	a0,a0,254 # 7e58 <malloc+0x1e34>
    4d62:	00001097          	auipc	ra,0x1
    4d66:	204080e7          	jalr	516(ra) # 5f66 <printf>
        exit(1);
    4d6a:	4505                	li	a0,1
    ...
    4d78:	0f450513          	addi	a0,a0,244 # 7e68 <malloc+0x1e44>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	1ea080e7          	jalr	490(ra) # 5f66 <printf>
          exit(1);
    4d84:	4505                	li	a0,1
    ...
    4da0:	0e450513          	addi	a0,a0,228 # 7e80 <malloc+0x1e5c>
    4da4:	00001097          	auipc	ra,0x1
    4da8:	1c2080e7          	jalr	450(ra) # 5f66 <printf>
          exit(1);
    4dac:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	06650513          	addi	a0,a0,102 # 7e90 <malloc+0x1e6c>
    4e32:	00001097          	auipc	ra,0x1
    4e36:	134080e7          	jalr	308(ra) # 5f66 <printf>
      exit(1);
    4e3a:	4505                	li	a0,1
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	01cb8b93          	addi	s7,s7,28 # 7ea8 <malloc+0x1e84>
  for(i = 0; i < N; i++){
    ...
    4ed2:	fe250513          	addi	a0,a0,-30 # 7eb0 <malloc+0x1e8c>
    4ed6:	00001097          	auipc	ra,0x1
    4eda:	090080e7          	jalr	144(ra) # 5f66 <printf>
        exit(1);
    4ede:	4505                	li	a0,1
    ...
    4ef0:	fbc50513          	addi	a0,a0,-68 # 7ea8 <malloc+0x1e84>
  ...
  fd = open(".", 0);
    ...
    4f28:	92c50513          	addi	a0,a0,-1748 # 6850 <malloc+0x82c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	f3650513          	addi	a0,a0,-202 # 7ed0 <malloc+0x1eac>
    4fa2:	00001097          	auipc	ra,0x1
    4fa6:	fc4080e7          	jalr	-60(ra) # 5f66 <printf>
        exit(1);
    4faa:	4505                	li	a0,1
    ...
    4fbe:	f3650513          	addi	a0,a0,-202 # 7ef0 <malloc+0x1ecc>
    4fc2:	00001097          	auipc	ra,0x1
    4fc6:	fa4080e7          	jalr	-92(ra) # 5f66 <printf>
        exit(1);
    4fca:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	f2650513          	addi	a0,a0,-218 # 7f18 <malloc+0x1ef4>
    4ffa:	00001097          	auipc	ra,0x1
    4ffe:	f6c080e7          	jalr	-148(ra) # 5f66 <printf>
    exit(1);
    5002:	4505                	li	a0,1
    ...
    5012:	9e250513          	addi	a0,a0,-1566 # 69f0 <malloc+0x9cc>
    5016:	00001097          	auipc	ra,0x1
    501a:	f50080e7          	jalr	-176(ra) # 5f66 <printf>
      exit(1);
    501e:	4505                	li	a0,1
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	d1050513          	addi	a0,a0,-752 # 7f50 <malloc+0x1f2c>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	cbc50513          	addi	a0,a0,-836 # 7f60 <malloc+0x1f3c>
    52ac:	00001097          	auipc	ra,0x1
    52b0:	cba080e7          	jalr	-838(ra) # 5f66 <printf>
    exit(1);
    52b4:	4505                	li	a0,1
    ...
    52c4:	cc050513          	addi	a0,a0,-832 # 7f80 <malloc+0x1f5c>
    52c8:	00001097          	auipc	ra,0x1
    52cc:	c9e080e7          	jalr	-866(ra) # 5f66 <printf>
      exit(1);
    52d0:	4505                	li	a0,1
    ...
    52e0:	cc450513          	addi	a0,a0,-828 # 7fa0 <malloc+0x1f7c>
    52e4:	00001097          	auipc	ra,0x1
    52e8:	c82080e7          	jalr	-894(ra) # 5f66 <printf>
    exit(1);
    52ec:	4505                	li	a0,1
    ...
    52fc:	cc850513          	addi	a0,a0,-824 # 7fc0 <malloc+0x1f9c>
    5300:	00001097          	auipc	ra,0x1
    5304:	c66080e7          	jalr	-922(ra) # 5f66 <printf>
      exit(1);
    5308:	4505                	li	a0,1
    ...
    5318:	ccc50513          	addi	a0,a0,-820 # 7fe0 <malloc+0x1fbc>
    531c:	00001097          	auipc	ra,0x1
    5320:	c4a080e7          	jalr	-950(ra) # 5f66 <printf>
      exit(1);
    5324:	4505                	li	a0,1
    ...
    5334:	cc850513          	addi	a0,a0,-824 # 7ff8 <malloc+0x1fd4>
    5338:	00001097          	auipc	ra,0x1
    533c:	c2e080e7          	jalr	-978(ra) # 5f66 <printf>
      exit(1);
    5340:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    5362:	bf250513          	addi	a0,a0,-1038 # 7f50 <malloc+0x1f2c>
    ...
    5386:	c9650513          	addi	a0,a0,-874 # 8018 <malloc+0x1ff4>
    538a:	00001097          	auipc	ra,0x1
    538e:	bdc080e7          	jalr	-1060(ra) # 5f66 <printf>
    exit(1);
    5392:	4505                	li	a0,1
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	c7e50513          	addi	a0,a0,-898 # 8038 <malloc+0x2014>
    53c2:	00001097          	auipc	ra,0x1
    53c6:	ba4080e7          	jalr	-1116(ra) # 5f66 <printf>
  for(nfiles = 0; ; nfiles++){
    53ca:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53de:	c6ec8c93          	addi	s9,s9,-914 # 8048 <malloc+0x2024>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5436:	b34080e7          	jalr	-1228(ra) # 5f66 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5458:	c0450513          	addi	a0,a0,-1020 # 8058 <malloc+0x2034>
    545c:	00001097          	auipc	ra,0x1
    5460:	b0a080e7          	jalr	-1270(ra) # 5f66 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	bae50513          	addi	a0,a0,-1106 # 8078 <malloc+0x2054>
    54d2:	00001097          	auipc	ra,0x1
    54d6:	a94080e7          	jalr	-1388(ra) # 5f66 <printf>
}
    ...
    551e:	b4e50513          	addi	a0,a0,-1202 # 8068 <malloc+0x2044>
    5522:	00001097          	auipc	ra,0x1
    5526:	a44080e7          	jalr	-1468(ra) # 5f66 <printf>
    close(fd);
    552a:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	b4450513          	addi	a0,a0,-1212 # 8090 <malloc+0x206c>
    5554:	00001097          	auipc	ra,0x1
    5558:	a12080e7          	jalr	-1518(ra) # 5f66 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5580:	b3c50513          	addi	a0,a0,-1220 # 80b8 <malloc+0x2094>
    5584:	00001097          	auipc	ra,0x1
    5588:	9e2080e7          	jalr	-1566(ra) # 5f66 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55a4:	b0050513          	addi	a0,a0,-1280 # 80a0 <malloc+0x207c>
    55a8:	00001097          	auipc	ra,0x1
    55ac:	9be080e7          	jalr	-1602(ra) # 5f66 <printf>
    exit(1);
    55b0:	4505                	li	a0,1
    ...
    55cc:	af850513          	addi	a0,a0,-1288 # 80c0 <malloc+0x209c>
    55d0:	00001097          	auipc	ra,0x1
    55d4:	996080e7          	jalr	-1642(ra) # 5f66 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	ab050513          	addi	a0,a0,-1360 # 80c8 <malloc+0x20a4>
    5620:	00001097          	auipc	ra,0x1
    5624:	946080e7          	jalr	-1722(ra) # 5f66 <printf>
        return 1;
    5628:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	b6698993          	addi	s3,s3,-1178 # 61d8 <malloc+0x1b4>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	a7c50513          	addi	a0,a0,-1412 # 8120 <malloc+0x20fc>
    56ac:	00001097          	auipc	ra,0x1
    56b0:	8ba080e7          	jalr	-1862(ra) # 5f66 <printf>
        exit(1);
    56b4:	4505                	li	a0,1
    ...
    56c2:	a2250513          	addi	a0,a0,-1502 # 80e0 <malloc+0x20bc>
    56c6:	00001097          	auipc	ra,0x1
    56ca:	8a0080e7          	jalr	-1888(ra) # 5f66 <printf>
    exit(1);
    56ce:	4505                	li	a0,1
    ...
    56dc:	a2850513          	addi	a0,a0,-1496 # 8100 <malloc+0x20dc>
    56e0:	00001097          	auipc	ra,0x1
    56e4:	886080e7          	jalr	-1914(ra) # 5f66 <printf>
    exit(1);
    56e8:	4505                	li	a0,1
  ...
  while(1){
    ...
    572a:	a1a50513          	addi	a0,a0,-1510 # 8140 <malloc+0x211c>
    572e:	00001097          	auipc	ra,0x1
    5732:	838080e7          	jalr	-1992(ra) # 5f66 <printf>
      exit(1);
    5736:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	9d8b8b93          	addi	s7,s7,-1576 # 8160 <malloc+0x213c>
    int free0 = countfree();
    int free1 = 0;
    ...
    57d6:	794080e7          	jalr	1940(ra) # 5f66 <printf>
    int free0 = countfree();
    ...
    5826:	744080e7          	jalr	1860(ra) # 5f66 <printf>
      if(continuous != 2) {
    ...
    5836:	734080e7          	jalr	1844(ra) # 5f66 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	92858593          	addi	a1,a1,-1752 # 81c8 <malloc+0x21a4>
    ...
    58ba:	96a58593          	addi	a1,a1,-1686 # 8220 <malloc+0x21fc>
    ...
    58d0:	94c58593          	addi	a1,a1,-1716 # 8218 <malloc+0x21f4>
  ...
  int continuous = 0;
    ...
    58fc:	8d850513          	addi	a0,a0,-1832 # 81d0 <malloc+0x21ac>
    5900:	00000097          	auipc	ra,0x0
    5904:	666080e7          	jalr	1638(ra) # 5f66 <printf>
    exit(1);
    5908:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	8dc50513          	addi	a0,a0,-1828 # 8200 <malloc+0x21dc>
    592c:	00000097          	auipc	ra,0x0
    5930:	63a080e7          	jalr	1594(ra) # 5f66 <printf>
  exit(0);
    5934:	4501                	li	a0,0
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5ca4:	f46080e7          	jalr	-186(ra) # 5be6 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    5cc2:	0805c863          	bltz	a1,5d52 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    5cd6:	8be50513          	addi	a0,a0,-1858 # 8590 <digits>
    5cda:	883a                	mv	a6,a4
  ...
  if(neg)
    5cfe:	00088b63          	beqz	a7,5d14 <printint+0x64>
    buf[i++] = '-';
    5d02:	fd040793          	addi	a5,s0,-48
    5d06:	973e                	add	a4,a4,a5
    5d08:	02d00793          	li	a5,45
    5d0c:	fef70823          	sb	a5,-16(a4)
    5d10:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5d14:	02e05863          	blez	a4,5d44 <printint+0x94>
    5d18:	fc040793          	addi	a5,s0,-64
    5d1c:	00e78933          	add	s2,a5,a4
    5d20:	fff78993          	addi	s3,a5,-1
    5d24:	99ba                	add	s3,s3,a4
    5d26:	377d                	addiw	a4,a4,-1
    5d28:	1702                	slli	a4,a4,0x20
    5d2a:	9301                	srli	a4,a4,0x20
    5d2c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d30:	fff94583          	lbu	a1,-1(s2)
    5d34:	8526                	mv	a0,s1
    5d36:	00000097          	auipc	ra,0x0
    5d3a:	f58080e7          	jalr	-168(ra) # 5c8e <putc>
  while(--i >= 0)
    5d3e:	197d                	addi	s2,s2,-1
    5d40:	ff3918e3          	bne	s2,s3,5d30 <printint+0x80>
}
    ...
    5d4e:	6121                	addi	sp,sp,64
    5d50:	8082                	ret
    x = -xx;
    5d52:	40b005bb          	negw	a1,a1
    neg = 1;
    5d56:	4885                	li	a7,1
    x = -xx;
    5d58:	bf8d                	j	5cca <printint+0x1a>

0000000000005d5a <vprintf>:
}
...
{
    5d5a:	7119                	addi	sp,sp,-128
    5d5c:	fc86                	sd	ra,120(sp)
    5d5e:	f8a2                	sd	s0,112(sp)
    5d60:	f4a6                	sd	s1,104(sp)
    5d62:	f0ca                	sd	s2,96(sp)
    5d64:	ecce                	sd	s3,88(sp)
    5d66:	e8d2                	sd	s4,80(sp)
    5d68:	e4d6                	sd	s5,72(sp)
    5d6a:	e0da                	sd	s6,64(sp)
    5d6c:	fc5e                	sd	s7,56(sp)
    5d6e:	f862                	sd	s8,48(sp)
    5d70:	f466                	sd	s9,40(sp)
    5d72:	f06a                	sd	s10,32(sp)
    5d74:	ec6e                	sd	s11,24(sp)
    5d76:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5d78:	0005c903          	lbu	s2,0(a1)
    5d7c:	18090f63          	beqz	s2,5f1a <vprintf+0x1c0>
    5d80:	8aaa                	mv	s5,a0
    5d82:	8b32                	mv	s6,a2
    5d84:	00158493          	addi	s1,a1,1
  state = 0;
    5d88:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5d8a:	02500a13          	li	s4,37
      if(c == 'd'){
    5d8e:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5d92:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5d96:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5d9a:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d9e:	00002b97          	auipc	s7,0x2
    5da2:	7f2b8b93          	addi	s7,s7,2034 # 8590 <digits>
    5da6:	a839                	j	5dc4 <vprintf+0x6a>
        putc(fd, c);
    5da8:	85ca                	mv	a1,s2
    5daa:	8556                	mv	a0,s5
    5dac:	00000097          	auipc	ra,0x0
    5db0:	ee2080e7          	jalr	-286(ra) # 5c8e <putc>
    5db4:	a019                	j	5dba <vprintf+0x60>
    } else if(state == '%'){
    5db6:	01498f63          	beq	s3,s4,5dd4 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5dba:	0485                	addi	s1,s1,1
    5dbc:	fff4c903          	lbu	s2,-1(s1)
    5dc0:	14090d63          	beqz	s2,5f1a <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5dc4:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5dc8:	fe0997e3          	bnez	s3,5db6 <vprintf+0x5c>
      if(c == '%'){
    5dcc:	fd479ee3          	bne	a5,s4,5da8 <vprintf+0x4e>
        state = '%';
    5dd0:	89be                	mv	s3,a5
    5dd2:	b7e5                	j	5dba <vprintf+0x60>
      if(c == 'd'){
    5dd4:	05878063          	beq	a5,s8,5e14 <vprintf+0xba>
      } else if(c == 'l') {
    5dd8:	05978c63          	beq	a5,s9,5e30 <vprintf+0xd6>
      } else if(c == 'x') {
    5ddc:	07a78863          	beq	a5,s10,5e4c <vprintf+0xf2>
      } else if(c == 'p') {
    5de0:	09b78463          	beq	a5,s11,5e68 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5de4:	07300713          	li	a4,115
    5de8:	0ce78663          	beq	a5,a4,5eb4 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5dec:	06300713          	li	a4,99
    5df0:	0ee78e63          	beq	a5,a4,5eec <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5df4:	11478863          	beq	a5,s4,5f04 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5e00:	e92080e7          	jalr	-366(ra) # 5c8e <putc>
        putc(fd, c);
    5e04:	85ca                	mv	a1,s2
    5e06:	8556                	mv	a0,s5
    5e08:	00000097          	auipc	ra,0x0
    5e0c:	e86080e7          	jalr	-378(ra) # 5c8e <putc>
      }
      state = 0;
    5e10:	4981                	li	s3,0
    5e12:	b765                	j	5dba <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5e26:	e8e080e7          	jalr	-370(ra) # 5cb0 <printint>
    5e2a:	8b4a                	mv	s6,s2
      state = 0;
    5e2c:	4981                	li	s3,0
    5e2e:	b771                	j	5dba <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5e30:	008b0913          	addi	s2,s6,8
    5e34:	4681                	li	a3,0
    5e36:	4629                	li	a2,10
    5e38:	000b2583          	lw	a1,0(s6)
    5e3c:	8556                	mv	a0,s5
    5e3e:	00000097          	auipc	ra,0x0
    5e42:	e72080e7          	jalr	-398(ra) # 5cb0 <printint>
    5e46:	8b4a                	mv	s6,s2
      state = 0;
    5e48:	4981                	li	s3,0
    5e4a:	bf85                	j	5dba <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5e4c:	008b0913          	addi	s2,s6,8
    5e50:	4681                	li	a3,0
    5e52:	4641                	li	a2,16
    5e54:	000b2583          	lw	a1,0(s6)
    5e58:	8556                	mv	a0,s5
    5e5a:	00000097          	auipc	ra,0x0
    5e5e:	e56080e7          	jalr	-426(ra) # 5cb0 <printint>
    5e62:	8b4a                	mv	s6,s2
      state = 0;
    5e64:	4981                	li	s3,0
    5e66:	bf91                	j	5dba <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5e68:	008b0793          	addi	a5,s6,8
    5e6c:	f8f43423          	sd	a5,-120(s0)
    5e70:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5e74:	03000593          	li	a1,48
    5e78:	8556                	mv	a0,s5
    5e7a:	00000097          	auipc	ra,0x0
    5e7e:	e14080e7          	jalr	-492(ra) # 5c8e <putc>
  putc(fd, 'x');
    5e82:	85ea                	mv	a1,s10
    5e84:	8556                	mv	a0,s5
    5e86:	00000097          	auipc	ra,0x0
    5e8a:	e08080e7          	jalr	-504(ra) # 5c8e <putc>
    5e8e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e90:	03c9d793          	srli	a5,s3,0x3c
    5e94:	97de                	add	a5,a5,s7
    5e96:	0007c583          	lbu	a1,0(a5)
    5e9a:	8556                	mv	a0,s5
    5e9c:	00000097          	auipc	ra,0x0
    5ea0:	df2080e7          	jalr	-526(ra) # 5c8e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5ea4:	0992                	slli	s3,s3,0x4
    5ea6:	397d                	addiw	s2,s2,-1
    5ea8:	fe0914e3          	bnez	s2,5e90 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5eac:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5eb0:	4981                	li	s3,0
    5eb2:	b721                	j	5dba <vprintf+0x60>
        s = va_arg(ap, char*);
    5eb4:	008b0993          	addi	s3,s6,8
    5eb8:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5ebc:	02090163          	beqz	s2,5ede <vprintf+0x184>
        while(*s != 0){
    5ec0:	00094583          	lbu	a1,0(s2)
    5ec4:	c9a1                	beqz	a1,5f14 <vprintf+0x1ba>
          putc(fd, *s);
    5ec6:	8556                	mv	a0,s5
    5ec8:	00000097          	auipc	ra,0x0
    5ecc:	dc6080e7          	jalr	-570(ra) # 5c8e <putc>
          s++;
    5ed0:	0905                	addi	s2,s2,1
        while(*s != 0){
    5ed2:	00094583          	lbu	a1,0(s2)
    5ed6:	f9e5                	bnez	a1,5ec6 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5ed8:	8b4e                	mv	s6,s3
      state = 0;
    5eda:	4981                	li	s3,0
    5edc:	bdf9                	j	5dba <vprintf+0x60>
          s = "(null)";
    5ede:	00002917          	auipc	s2,0x2
    5ee2:	6aa90913          	addi	s2,s2,1706 # 8588 <malloc+0x2564>
        while(*s != 0){
    5ee6:	02800593          	li	a1,40
    5eea:	bff1                	j	5ec6 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5eec:	008b0913          	addi	s2,s6,8
    5ef0:	000b4583          	lbu	a1,0(s6)
    5ef4:	8556                	mv	a0,s5
    5ef6:	00000097          	auipc	ra,0x0
    5efa:	d98080e7          	jalr	-616(ra) # 5c8e <putc>
    5efe:	8b4a                	mv	s6,s2
      state = 0;
    5f00:	4981                	li	s3,0
    5f02:	bd65                	j	5dba <vprintf+0x60>
        putc(fd, c);
    5f04:	85d2                	mv	a1,s4
    5f06:	8556                	mv	a0,s5
    5f08:	00000097          	auipc	ra,0x0
    5f0c:	d86080e7          	jalr	-634(ra) # 5c8e <putc>
      state = 0;
    5f10:	4981                	li	s3,0
    5f12:	b565                	j	5dba <vprintf+0x60>
        s = va_arg(ap, char*);
    5f14:	8b4e                	mv	s6,s3
      state = 0;
    5f16:	4981                	li	s3,0
    5f18:	b54d                	j	5dba <vprintf+0x60>
    }
  }
}
    5f1a:	70e6                	ld	ra,120(sp)
    5f1c:	7446                	ld	s0,112(sp)
    5f1e:	74a6                	ld	s1,104(sp)
    5f20:	7906                	ld	s2,96(sp)
    5f22:	69e6                	ld	s3,88(sp)
    5f24:	6a46                	ld	s4,80(sp)
    5f26:	6aa6                	ld	s5,72(sp)
    5f28:	6b06                	ld	s6,64(sp)
    5f2a:	7be2                	ld	s7,56(sp)
    5f2c:	7c42                	ld	s8,48(sp)
    5f2e:	7ca2                	ld	s9,40(sp)
    5f30:	7d02                	ld	s10,32(sp)
    5f32:	6de2                	ld	s11,24(sp)
    5f34:	6109                	addi	sp,sp,128
    5f36:	8082                	ret

0000000000005f38 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5f38:	715d                	addi	sp,sp,-80
    5f3a:	ec06                	sd	ra,24(sp)
    5f3c:	e822                	sd	s0,16(sp)
    5f3e:	1000                	addi	s0,sp,32
    5f40:	e010                	sd	a2,0(s0)
    5f42:	e414                	sd	a3,8(s0)
    5f44:	e818                	sd	a4,16(s0)
    5f46:	ec1c                	sd	a5,24(s0)
    5f48:	03043023          	sd	a6,32(s0)
    5f4c:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f50:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f54:	8622                	mv	a2,s0
    5f56:	00000097          	auipc	ra,0x0
    5f5a:	e04080e7          	jalr	-508(ra) # 5d5a <vprintf>
}
    5f5e:	60e2                	ld	ra,24(sp)
    5f60:	6442                	ld	s0,16(sp)
    5f62:	6161                	addi	sp,sp,80
    5f64:	8082                	ret

0000000000005f66 <printf>:

void
printf(const char *fmt, ...)
{
    5f66:	711d                	addi	sp,sp,-96
    5f68:	ec06                	sd	ra,24(sp)
    5f6a:	e822                	sd	s0,16(sp)
    5f6c:	1000                	addi	s0,sp,32
    5f6e:	e40c                	sd	a1,8(s0)
    5f70:	e810                	sd	a2,16(s0)
    5f72:	ec14                	sd	a3,24(s0)
    5f74:	f018                	sd	a4,32(s0)
    5f76:	f41c                	sd	a5,40(s0)
    5f78:	03043823          	sd	a6,48(s0)
    5f7c:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f80:	00840613          	addi	a2,s0,8
    5f84:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f88:	85aa                	mv	a1,a0
    5f8a:	4505                	li	a0,1
    5f8c:	00000097          	auipc	ra,0x0
    5f90:	dce080e7          	jalr	-562(ra) # 5d5a <vprintf>
}
    5f94:	60e2                	ld	ra,24(sp)
    5f96:	6442                	ld	s0,16(sp)
    5f98:	6125                	addi	sp,sp,96
    5f9a:	8082                	ret

0000000000005f9c <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f9c:	1141                	addi	sp,sp,-16
    5f9e:	e422                	sd	s0,8(sp)
    5fa0:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fa2:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fa6:	00003797          	auipc	a5,0x3
    5faa:	4aa7b783          	ld	a5,1194(a5) # 9450 <freep>
    5fae:	a805                	j	5fde <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fb0:	4618                	lw	a4,8(a2)
    5fb2:	9db9                	addw	a1,a1,a4
    5fb4:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fb8:	6398                	ld	a4,0(a5)
    5fba:	6318                	ld	a4,0(a4)
    5fbc:	fee53823          	sd	a4,-16(a0)
    5fc0:	a091                	j	6004 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fc2:	ff852703          	lw	a4,-8(a0)
    5fc6:	9e39                	addw	a2,a2,a4
    5fc8:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5fca:	ff053703          	ld	a4,-16(a0)
    5fce:	e398                	sd	a4,0(a5)
    5fd0:	a099                	j	6016 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fd2:	6398                	ld	a4,0(a5)
    5fd4:	00e7e463          	bltu	a5,a4,5fdc <free+0x40>
    5fd8:	00e6ea63          	bltu	a3,a4,5fec <free+0x50>
{
    5fdc:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fde:	fed7fae3          	bgeu	a5,a3,5fd2 <free+0x36>
    5fe2:	6398                	ld	a4,0(a5)
    5fe4:	00e6e463          	bltu	a3,a4,5fec <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fe8:	fee7eae3          	bltu	a5,a4,5fdc <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5fec:	ff852583          	lw	a1,-8(a0)
    5ff0:	6390                	ld	a2,0(a5)
    5ff2:	02059713          	slli	a4,a1,0x20
    5ff6:	9301                	srli	a4,a4,0x20
    5ff8:	0712                	slli	a4,a4,0x4
    5ffa:	9736                	add	a4,a4,a3
    5ffc:	fae60ae3          	beq	a2,a4,5fb0 <free+0x14>
    bp->s.ptr = p->s.ptr;
    6000:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    6004:	4790                	lw	a2,8(a5)
    6006:	02061713          	slli	a4,a2,0x20
    600a:	9301                	srli	a4,a4,0x20
    600c:	0712                	slli	a4,a4,0x4
    600e:	973e                	add	a4,a4,a5
    6010:	fae689e3          	beq	a3,a4,5fc2 <free+0x26>
  } else
    p->s.ptr = bp;
...
malloc(uint nbytes)
{
    ...
    602c:	f04a                	sd	s2,32(sp)
    602e:	ec4e                	sd	s3,24(sp)
    6030:	e852                	sd	s4,16(sp)
    6032:	e456                	sd	s5,8(sp)
    6034:	e05a                	sd	s6,0(sp)
    6036:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6038:	02051493          	slli	s1,a0,0x20
    603c:	9081                	srli	s1,s1,0x20
    603e:	04bd                	addi	s1,s1,15
    6040:	8091                	srli	s1,s1,0x4
    6042:	0014899b          	addiw	s3,s1,1
    6046:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    6048:	00003517          	auipc	a0,0x3
    604c:	40853503          	ld	a0,1032(a0) # 9450 <freep>
    6050:	c515                	beqz	a0,607c <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    6052:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    6054:	4798                	lw	a4,8(a5)
    6056:	02977f63          	bgeu	a4,s1,6094 <malloc+0x70>
    605a:	8a4e                	mv	s4,s3
  ...
  if(p == (char*)-1)
    6078:	5afd                	li	s5,-1
    607a:	a88d                	j	60ec <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    607c:	0000a797          	auipc	a5,0xa
    6080:	bfc78793          	addi	a5,a5,-1028 # fc78 <base>
    6084:	00003717          	auipc	a4,0x3
    6088:	3cf73623          	sd	a5,972(a4) # 9450 <freep>
    608c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    608e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    6092:	b7e1                	j	605a <malloc+0x36>
      if(p->s.size == nunits)
    6094:	02e48b63          	beq	s1,a4,60ca <malloc+0xa6>
        p->s.size -= nunits;
    6098:	4137073b          	subw	a4,a4,s3
    609c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    609e:	1702                	slli	a4,a4,0x20
    60a0:	9301                	srli	a4,a4,0x20
    60a2:	0712                	slli	a4,a4,0x4
    ...
    60ce:	bff1                	j	60aa <malloc+0x86>
  hp->s.size = nu;
    60d0:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60d4:	0541                	addi	a0,a0,16
    60d6:	00000097          	auipc	ra,0x0
    60da:	ec6080e7          	jalr	-314(ra) # 5f9c <free>
  return freep;
    60de:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60e2:	d971                	beqz	a0,60b6 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60e4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60e6:	4798                	lw	a4,8(a5)
    60e8:	fa9776e3          	bgeu	a4,s1,6094 <malloc+0x70>
    if(p == freep)
    60ec:	00093703          	ld	a4,0(s2)
    60f0:	853e                	mv	a0,a5
    60f2:	fef719e3          	bne	a4,a5,60e4 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    60f6:	8552                	mv	a0,s4
    60f8:	00000097          	auipc	ra,0x0
    60fc:	b56080e7          	jalr	-1194(ra) # 5c4e <sbrk>
  if(p == (char*)-1)
    6100:	fd5518e3          	bne	a0,s5,60d0 <malloc+0xac>
        return 0;
    6104:	4501                	li	a0,0
    6106:	bf45                	j	60b6 <malloc+0x92>
